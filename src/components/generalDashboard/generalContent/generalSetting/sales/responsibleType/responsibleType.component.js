...
import { resetProps, getResponsibleType, deleteResponsibleType, postResponsibleType, getResponsibleTypeItem } from '../../../../../../redux/sales/responsibleType/responsibleType.action'
...
class ResponsibleType extends PureComponent {
    ...
    /* #region  [- accessToMenu -] */
    accessToMenu = (data) => {
        if (data.includes("281")) {
            this.setState({
                isNewButtonHidden: false
            })
        }
        if (data.includes("285")) {
            this.setState({
                isEditButtonHidden: false
            })
        }
        if (data.includes("283")) {
            this.setState({
        ...
        if (data.includes("465")) {
            this.setState({
                isPrintButtonHidden: false
            })
        }
        if (data.includes("466")) {
            this.setState({
    ...
    getResponsibleType = async () => {
        ...
        await this.props.getResponsibleType(JSON.stringify(data));
    }
    /* #endregion */
    ...
    getResponsibleTypeItem = async () => {
        ...
        await this.props.getResponsibleTypeItem(JSON.stringify(data));
    }
    /* #endregion */
            ...
            <Container fluid className='reacstrap-container' style={{ padding: '0' }} >
                        ...
                        <Row name='row_01_Header' className='content-header-row' style={{ margin: '0 0 1% 0', padding: '0' }}>
                            ...
                            <Col className='content-header-col'>
                                <p className='content-header-title'>انواع مسئولیت</p>
                            </Col>
                            ...
                            <Modal name='delete'
                                ...
                                footer={[
                                    ...
                                    <Button key='2' className='submit-button-style'
                                        disabled={this.state.isModalDeleteButtonDisable} onClick={this.deleteInModal}>
                                        حذف
                            </Button>
                                ]}
                            >
...
const mapStateToProps = state => {
    return {
        ...
        message: state.responsibleType.message,
        responsibleTypeList: state.responsibleType.responsibleTypeList,
