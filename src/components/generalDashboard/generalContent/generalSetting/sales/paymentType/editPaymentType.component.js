...
import { putPaymentType } from '../../../../../../redux/sales/paymentType/paymentType.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class EditPaymentType extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.paymentTypeItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putPaymentType = async () => {
        let paymentTypePutData = {
            id: this.state.id,
        ...
        await this.props.putPaymentType(JSON.stringify(paymentTypePutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش روش پرداخت</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        paymentTypeItem: state.paymentType.paymentTypeItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putPaymentType: (data) => dispatch(putPaymentType(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditPaymentType);
