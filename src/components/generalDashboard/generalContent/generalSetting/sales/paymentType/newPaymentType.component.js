...
import { postPaymentType } from '../../../../../../redux/sales/paymentType/paymentType.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class NewPaymentType extends PureComponent {
            ...
            <Container fluid  className="reacstrap-container" style={{padding:"0"}} >
                            ...
                            <Row  name='row_01_Header' className='form-header-row' style={{margin:"0"}}>
                                <Col className="form-header-col">
                                    <p className="form-header-title">روش پرداخت جدید</p>
                                </Col>
                            </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(NewPaymentType);
