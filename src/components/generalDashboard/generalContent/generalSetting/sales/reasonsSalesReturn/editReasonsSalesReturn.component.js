...
import { putReasonsSalesReturn } from '../../../../../../redux/sales/reasonsSalesReturn/reasonsSalesReturn.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class EditReasonsSalesReturn extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.reasonsSalesReturnItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putReasonsSalesReturn = async () => {
        let reasonsSalesReturnPutData = {
            id: this.state.id,
        ...
        await this.props.putReasonsSalesReturn(JSON.stringify(reasonsSalesReturnPutData));
    }
    /* #endregion */
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.putReasonsSalesReturn();
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش علت مرجوعی</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        reasonsSalesReturnItem: state.reasonsSalesReturn.reasonsSalesReturnItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putReasonsSalesReturn: (data) => dispatch(putReasonsSalesReturn(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditReasonsSalesReturn);
