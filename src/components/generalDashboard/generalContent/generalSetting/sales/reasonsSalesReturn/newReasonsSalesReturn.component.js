...
import { postReasonsSalesReturn } from '../../../../../../redux/sales/reasonsSalesReturn/reasonsSalesReturn.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */
class NewReasonsSalesReturn extends PureComponent {
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postReasonsSalesReturn();
            ...
            <Container fluid  className="reacstrap-container" style={{padding:"0"}} >
                            ...
                            <Row  name='row_01_Header' className='form-header-row' style={{margin:"0"}}>
                                <Col className="form-header-col">
                                    <p className="form-header-title">علت مرجوعی جدید</p>
                                </Col>
                            </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(NewReasonsSalesReturn);
