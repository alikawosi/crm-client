...
import { postTaskStatus } from '../../../../../../redux/sales/taskStatus/taskStatus.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class NewTaskStatus extends PureComponent {
            ...
            <Container fluid  className="reacstrap-container" style={{padding:"0"}} >
                            ...
                            <Row  name='row_01_Header' className='form-header-row' style={{margin:"0"}}>
                                <Col className="form-header-col">
                                    <p className="form-header-title">وضعیت کار جدید</p>
                                </Col>
                            </Row>
                            ...
                            <Row  name='row_03_Buttons'  className='form-button-row' style={{margin:"0"}}>
...
export default connect(mapStateToProps, mapDispatchToProps)(NewTaskStatus);
