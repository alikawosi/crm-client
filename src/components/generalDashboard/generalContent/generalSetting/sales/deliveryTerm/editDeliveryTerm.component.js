...
import { putDeliveryTerm } from '../../../../../../redux/sales/deliveryTerm/deliveryTerm.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';

/* #endregion */

class EditDeliveryTerm extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.deliveryTermItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putDeliveryTerm = async () => {
        let deliveryTermPutData = {
            id: this.state.id,
        ...
        await this.props.putDeliveryTerm(JSON.stringify(deliveryTermPutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_ِHeader' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش شرایط تحویل</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        deliveryTermItem: state.deliveryTerm.deliveryTermItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putDeliveryTerm: (data) => dispatch(putDeliveryTerm(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditDeliveryTerm);
