...
import { putShippingMethod } from '../../../../../../redux/sales/shippingMethod/shippingMethod.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';

/* #endregion */

class EditShippingMethod extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.shippingMethodItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putShippingMethod = async () => {
        let shippingMethodPutData = {
            id: this.state.id,
        ...
        await this.props.putShippingMethod(JSON.stringify(shippingMethodPutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_ِHeader' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش روش حمل و نقل</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        shippingMethodItem: state.shippingMethod.shippingMethodItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putShippingMethod: (data) => dispatch(putShippingMethod(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditShippingMethod);
