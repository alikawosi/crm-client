...
import { postManualActivityType } from '../../../../../../redux/sales/manualActivityType/manualActivityType.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */
class NewManualActivityType extends PureComponent {
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postManualActivityType();
...
export default connect(mapStateToProps, mapDispatchToProps)(NewManualActivityType);
