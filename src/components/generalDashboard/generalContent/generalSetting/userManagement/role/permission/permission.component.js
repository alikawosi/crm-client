...
class Permission extends PureComponent {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      isSplitOrderToQuoteDisabled: false,
  ...
  componentDidMount() {
    this.setAccess(
      ...
      this.props.roleNotPermissionList
    );
  }
  /* #endregion */

  /* #region  [- setAccess -] */
  setAccess = (rolePermissionList, roleNotPermissionList) => {
    var item =''
    if (this.props.roleParentId === null) {
      this.setState({
        isManagementCartableDisabled: false,
      ...
      const sourceList = rolePermissionList;

      for (let i = 0; i < sourceList.length; i++) {
         item = sourceList[i].crmSourceId;
        switch (item) {
          case 1:
            this.setState({
          ...
          case 179:
            this.setState({
              isPrintProductCategoryChecked: true,
            });
            break;

          case 180:
            this.setState({
              isExcelProductCategoryChecked: true,
            });
            break;
          ...
          case (582, 583, 584, 585, 586, 587, 592):
            this.setState({
      ...
      for (let i = 0; i < sourceList.length; i++) {
        ...
        switch (item) {
          ...
          case (399, 400, 401, 402, 403, 404, 405, 406):
            this.setState({
              isNewQuoteChecked: true,
            });
            break;
        ...
        case (844,845):
          ...
          case (641, 583, 645, 646, 647, 648, 649):
            this.setState({
              isInvoiceTimelineChecked: true,
              isInvoiceTimelineTaskHidden: false,
            });
      ...
      const notPermissionSourceList = roleNotPermissionList;

      for (let i = 0; i < notPermissionSourceList.length; i++) {
         item = notPermissionSourceList[i].crmSourceId;
        switch (item) {
          case 1:
            this.setState({
              isManagementCartableDisabled: true,
            });
            break;

          case 9:
            this.setState({
              isSalesSettingDisabled: true,
            });
            break;

          case 3:
            this.setState({
              isSalesDisabled: true,
            });
            break;

          case 203:
            this.setState({
              isSalesManagementDisabled: true,
            });
            break;

          case 204:
            this.setState({
              isSalesManagementCartableDisabled: true,
            });
            break;
          ...
          // case 367:
          //   this.setState({
          //     isPrintInventoryDisabled: true,
          //   });
          //   break;

          case 205:
            this.setState({
              isPriceListDisabled: true,
            });
            break;

          case (382, 383):
            this.setState({
              isPriceListOperationDisabled: true,
            });
            break;

          case (384, 385, 386, 387, 388, 389, 390):
            this.setState({
              isNewPriceListDisabled: true,
            });
            break;

          case (385, 386, 387, 388, 389, 390, 391, 392):
            this.setState({
              isEditPriceListDisabled: true,
            });
            break;

          case (393, 394):
            this.setState({
              isDeletePriceListDisabled: true,
            });
            break;
          ...
          case (395, 396, 397, 398):
            this.setState({
              isQuoteOperationDisabled: true,
            });
            break;

          case (399, 400, 401, 402, 403, 404, 405, 406):
            this.setState({
              isNewQuoteDisabled: true,
            });
            break;

          case (400, 401, 402, 403, 404, 405, 406, 407, 408, 409):
            this.setState({
              isEditQuoteDisabled: true,
            });
            break;

          case (410, 411):
            this.setState({
              isDeleteQuoteDisabled: true,
            });
            break;

          case (483, 511, 512):
            this.setState({
              isMergeQuoteDisabled: true,
            });
            break;

          case (484, 513, 514):
            this.setState({
              isSplitQuoteDisabled: true,
            });
            break;

          case (485, 515, 516):
            this.setState({
              isConvertQuoteDisabled: true,
            });
            break;
          ...
          case (412, 413, 414, 415, 416, 417):
            this.setState({
              isOrderOperationDisabled: true,
            });
            break;

          case (418, 420, 421, 422, 423, 425, 426):
            this.setState({
              isNewOrderDisabled: true,
            });
            break;

          case (418, 420, 421, 422, 423, 425, 426, 427, 428, 429, 430):
            this.setState({
              isEditOrderDisabled: true,
            });
            break;
          ...
          case 486:
            this.setState({
              isConvertOrderToInvoiceDisabled: true,
            });
            break;

          case 487:
            this.setState({
              isMergeOrderToInvoiceDisabled: true,
            });
            break;

          case 488:
            this.setState({
              isSolitOrderToInvoiceDisabled: true,
            });
            break;
          ...
          case (433, 434, 435, 437, 438, 439):
            this.setState({
              isInvoiceOperationDisabled: true,
            });
            break;

          case (440, 441, 442, 443, 445, 446, 700, 701):
            this.setState({
              isNewInvoiceDisabled: true,
              isEditInvoiceChecked: true,
            });
            break;
          ...
          case 491:
            this.setState({
              isNewRequisitionDisabled: true,
            });
            break;

          case 496:
            this.setState({
              isDeleteRequisitionDisabled: true,
            });
            break;
          ...
          case 209:
            this.setState({
              isAccountManagementDisabled: true,
            });
            break;

          case 210:
            this.setState({
              isCRMCartableDisabled: true,
            });
            break;

          case (368, 369):
            this.setState({
              isCRMCartableOperationDisabled: true,
            });
            break;
          ...
          case (371, 372, 373, 374, 375, 376, 377):
            this.setState({
              isEditAccountDisabled: true,
            });
            break;

          case (378, 379):
            this.setState({
              isDeleteAccountDisabled: true,
            });
            break;

          case (380, 381):
            this.setState({
              isAccountChangeLevelDisabled: true,
            });
            break;
          ...
          case (16, 17):
            this.setState({
              isRealPersonDisabled: true,
            });
            break;

          case (18, 19):
            this.setState({
              isNewRealPersonDisabled: true,
            });
            break;

          case (20, 21, 22):
            this.setState({
              isEditRealPersonDisabled: true,
            });
            break;

          case (23, 24):
            this.setState({
              isDeleteRealPersonDisabled: true,
            });
            break;

          case 25:
            this.setState({
              isPrintRealPersonDisabled: true,
            });
            break;

          case 26:
            this.setState({
              isExcelRealPersonDisabled: true,
            });
            break;

          case (27, 28):
            this.setState({
              isLegalPersonDisabled: true,
            });
            break;

          case (29, 30):
            this.setState({
              isNewLegalPersonDisabled: true,
            });
            break;

          case (31, 32, 33):
            this.setState({
              isEditLegalPersonDisabled: true,
            });
            break;

          case (34, 35):
            this.setState({
              isDeleteLegalPersonDisabled: true,
            });
            break;

          case 36:
            this.setState({
              isPrintLegalPersonDisabled: true,
            });
            break;

          case 37:
            this.setState({
              isExcelLegalPersonDisabled: true,
            });
            break;

          case (38, 39):
            this.setState({
              isIndustryDisabled: true,
            });
            break;

          case (40, 41):
            this.setState({
              isNewIndustryDisabled: true,
            });
            break;

          case (42, 43, 44):
            this.setState({
              isEditIndustryDisabled: true,
            });
            break;

          case (45, 46):
            this.setState({
              isDeleteIndustryDisabled: true,
            });
            break;

          case 47:
            this.setState({
              isPrintIndustryDisabled: true,
            });
            break;

          case 48:
            this.setState({
              isExcelIndustryDisabled: true,
            });
            break;

          case (49, 50):
            this.setState({
              isOrganizationTypeDisabled: true,
            });
            break;

          case (51, 52):
            this.setState({
              isNewOrganizationTypeDisabled: true,
            });
            break;

          case (53, 54, 55):
            this.setState({
              isEditOrganizationTypeDisabled: true,
            });
            break;

          case (56, 57):
            this.setState({
              isDeleteOrganizationTypeDisabled: true,
            });
            break;

          case 58:
            this.setState({
              isPrintOrganizationTypeDisabled: true,
            });
            break;

          case 59:
            this.setState({
              isExcelOrganizationTypeDisabled: true,
            });
            break;
          ...
          case (62, 63):
            this.setState({
              isNewCategoryTypeDisabled: true,
            });
            break;

          case (64, 65, 66):
            this.setState({
              isEditCategoryTypeDisabled: true,
            });
            break;

          case (67, 68):
            this.setState({
              isDeleteCategoryTypeDisabled: true,
            });
            break;

          case 69:
            this.setState({
              isPrintCategoryTypeDisabled: true,
            });
            break;

          case 70:
            this.setState({
              isExcelCategoryTypeDisabled: true,
            });
            break;

          case (71, 72):
            this.setState({
              isEducationLevelDisabled: true,
            });
            break;

          case (73, 74):
            this.setState({
              isNewEducationLevelDisabled: true,
            });
            break;

          case (75, 76, 77):
            this.setState({
              isEditEducationLevelDisabled: true,
            });
            break;

          case (78, 79):
            this.setState({
              isDeleteEducationLevelDisabled: true,
            });
            break;

          case 80:
            this.setState({
              isPrintEducationLevelDisabled: true,
            });
            break;

          case 81:
            this.setState({
              isExcelEducationLevelDisabled: true,
            });
            break;

          case (82, 83):
            this.setState({
              isRepresentativeTypeDisabled: true,
            });
            break;

          case (84, 85):
            this.setState({
              isNewRepresentativeTypeDisabled: true,
            });
            break;

          case (86, 87, 88):
            this.setState({
              isEditRepresentativeTypeDisabled: true,
            });
            break;

          case (89, 90):
            this.setState({
              isDeleteRepresentativeTypeDisabled: true,
            });
            break;

          case 91:
            this.setState({
              isPrintRepresentativeTypeDisabled: true,
            });
            break;

          case 92:
            this.setState({
              isExcelRepresentativeTypeDisabled: true,
            });
            break;
          ...
          case (95, 96):
            this.setState({
              isNewTemplateDisabled: true,
            });
            break;

          case (97, 98, 99):
            this.setState({
              isEditTemplateDisabled: true,
            });
            break;
          ...
          case 102:
            this.setState({
              isPrintTemplateDisabled: true,
            });
            break;

          case 103:
            this.setState({
              isExcelTemplateDisabled: true,
            });
            break;
          ...
          case (791, 792,793,794):
            this.setState({
              isMaterialCardDisabled: true,
            });
            break;

          case (795, 796,797,798,799,800,801,802,803,804,805,806,807,808,913):
            this.setState({
              isNewMaterialDisabled: true,
            });
            break;

          case (811,812,813,814,815,816,817,818,819,820,821,822,823,824,825,826,827,914):
            this.setState({
              isEditMaterialDisabled: true,
            });
            break;

          case (809, 810):
            this.setState({
              isDeleteMaterialDisabled: true,
            });
            break;

          // case 113:
          //   this.setState({
          //     isPrintMaterialDisabled: true,
          //   });
          //   break;

          // case 114:
          //   this.setState({
          //     isExcelMaterialDisabled: true,
          //   });
          //   break;

          case (780, 781):
            this.setState({
              isMaterialCategoryDisabled: true,
            });
            break;

          case (782, 783,784):
            this.setState({
              isNewMaterialCategoryDisabled: true,
            });
            break;

          case (787,788,789,790):
            this.setState({
              isEditMaterialCategoryDisabled: true,
            });
            break;

          case (785,786):
            this.setState({
              isDeleteMaterialCategoryDisabled: true,
            });
            break;

          // case 124:
          //   this.setState({
          //     isPrintMaterialCategoryDisabled: true,
          //   });
          //   break;

          // case 125:
          //   this.setState({
          //     isExcelMaterialCategoryDisabled: true,
          //   });
          //   break;
          ...
          case (830,831,832):
            this.setState({
              isNewScaleDisabled: true,
            });
            break;

          case (836,837,838):
            this.setState({
              isEditScaleDisabled: true,
            });
            break;

          case (833, 834):
            this.setState({
              isDeleteScaleDisabled: true,
            });
            break;

          // case 135:
          //   this.setState({
          //     isPrintScaleDisabled: true,
          //   });
          //   break;

          // case 136:
          //   this.setState({
          //     isExcelScaleDisabled: true,
          //   });
          //   break;

          case (861, 862):
            this.setState({
              isWarehouseCategoryDisabled: true,
            });
            break;

          case (863, 864,865):
            this.setState({
              isNewWarehouseCategoryDisabled: true,
            });
            break;

          case (868, 869, 870):
            this.setState({
              isEditWarehouseCategoryDisabled: true,
            });
            break;

          case (866, 867):
            this.setState({
              isDeleteWarehouseCategoryDisabled: true,
            });
            break;

          // case 146:
          //   this.setState({
          //     isPrintWarehouseCategoryDisabled: true,
          //   });
          //   break;

          // case 147:
          //   this.setState({
          //     isExcelWarehouseCategoryDisabled: true,
          //   });
          //   break;
          ...
          case (873, 874,875,876,883,884,885,886,887,888):
            this.setState({
              isNewWarehouseDisabled: true,
            });
            break;

          case (879,880,881,882,889,890,891,892,893,894):
            this.setState({
              isEditWarehouseDisabled: true,
            });
            break;

          case (877, 878):
            this.setState({
              isDeleteWarehouseDisabled: true,
            });
            break;

          // case 157:
          //   this.setState({
          //     isPrintWarehouseDisabled: true,
          //   });
          //   break;

          // case 158:
          //   this.setState({
          //     isExcelWarehouseDisabled: true,
          //   });
          //   break;
          ...
          case (900,901,902,903,904,905,906,907):
            this.setState({
              isNewProductDisabled: true,
            });
            break;

          case (910,911,912):
            this.setState({
              isEditProductDisabled: true,
            });
            break;

          case (908,909):
            this.setState({
              isDeleteProductDisabled: true,
            });
            break;

          // case 168:
          //   this.setState({
          //     isPrintProductDisabled: true,
          //   });
          //   break;

          // case 169:
          //   this.setState({
          //     isExcelProductDisabled: true,
          //   });
          //   break;

          case (850,851):
            this.setState({
              isProductCategoryDisabled: true,
            });
            break;

          case (852,853,854,855):
            this.setState({
              isNewProductCategoryDisabled: true,
            });
            break;

          case (858,859,860):
            this.setState({
              isEditProductCategoryDisabled: true,
            });
            break;

          case (856,857):
            this.setState({
              isDeleteProductCategoryDisabled: true,
            });
            break;
          ...
          case 179:
            this.setState({
              isPrintProductCategoryDisabled: true,
            });
            break;

          case 180:
            this.setState({
              isExcelProductCategoryDisabled: true,
            });
            break;

            case (170, 171):
              this.setState({
                isSupplyChainDisabled: true,
              });
              break;
  
            case (172, 173):
              this.setState({
                isNewSupplyChainDisabled: true,
              });
              break;
  
            case (174, 175, 176):
              this.setState({
                isEditSupplyChainDisabled: true,
              });
              break;
  
            case (177, 178):
              this.setState({
                isDeleteSupplyChainDisabled: true,
              });
              break;
  
            case 179:
              this.setState({
                isPrintSupplyChainDisabled: true,
              });
              break;
  
            case 180:
              this.setState({
                isExcelSupplyChainDisabled: true,
              });
              break;
          ...
          case 11:
            this.setState({
              isServicesSettingDisabled: true,
            });
            break;
          ...
          case (183, 184):
            this.setState({
              isNewRoleDisabled: true,
            });
            break;

          case (185, 186, 187):
            this.setState({
              isEditRoleDisabled: true,
            });
            break;

          case (188, 189):
            this.setState({
              isDeleteRoleDisabled: true,
            });
            break;

          case 190:
            this.setState({
              isPrintRoleDisabled: true,
            });
            break;

          case 191:
            this.setState({
              isExcelRoleDisabled: true,
            });
            break;
          ...
          case (194, 195, 359, 360, 361):
            this.setState({
              isNewUserDisabled: true,
            });
            break;

          case (196, 197, 362, 363, 364, 365, 366):
            this.setState({
              isEditUserDisabled: true,
            });
            break;

          case (199, 200):
            this.setState({
              isDeleteUserDisabled: true,
            });
            break;

          case 201:
            this.setState({
              isPrintUserDisabled: true,
            });
            break;

          case 202:
            this.setState({
              isExcelUserDisabled: true,
            });
            break;
          ...
          case (224, 226):
            this.setState({
              isNewAccountTypeDisabled: true,
            });
            break;

          case (229, 230, 231):
            this.setState({
              isEditAccountTypeDisabled: true,
            });
            break;

          case (227, 228):
            this.setState({
              isDeleteAccountTypeDisabled: true,
            });
            break;

          case 453:
            this.setState({
              isPrintAccountTypeDisabled: true,
            });
            break;

          case 454:
            this.setState({
              isExcelAccountTypeDisabled: true,
            });
            break;

          case (232, 233):
            this.setState({
              isFinancialCaseTypeDisabled: true,
            });
            break;

          case (234, 235):
            this.setState({
              isNewFinancialCaseTypeDisabled: true,
            });
            break;

          case (238, 239, 240):
            this.setState({
              isEditFinancialCaseTypeDisabled: true,
            });
            break;

          case (236, 237):
            this.setState({
              isDeleteFinancialCaseTypeDisabled: true,
            });
            break;

          case 455:
            this.setState({
              isPrintFinancialCaseTypeDisabled: true,
            });
            break;

          case 456:
            this.setState({
              isExcelFinancialCaseTypeDisabled: true,
            });
            break;

          case (241, 242):
            this.setState({
              isTermTypeDisabled: true,
            });
            break;

          case (243, 244):
            this.setState({
              isNewTermTypeDisabled: true,
            });
            break;

          case (247, 248, 249):
            this.setState({
              isEditTermTypeDisabled: true,
            });
            break;

          case (245, 246):
            this.setState({
              isDeleteTermTypeDisabled: true,
            });
            break;

          case 457:
            this.setState({
              isPrintTermTypeDisabled: true,
            });
            break;

          case 458:
            this.setState({
              isExcelTermTypeDisabled: true,
            });
            break;
          ...
          case (252, 253):
            this.setState({
              isNewPaymentMethodDisabled: true,
            });
            break;

          case (256, 257, 258):
            this.setState({
              isEditPaymentMethodDisabled: true,
            });
            break;

          case (254, 255):
            this.setState({
              isDeletePaymentMethodDisabled: true,
            });
            break;

          case 459:
            this.setState({
              isPrintPaymentMethodDisabled: true,
            });
            break;

          case 460:
            this.setState({
              isExcelPaymentMethodDisabled: true,
            });
            break;

          case (259, 260):
            this.setState({
              isDeliveryTermDisabled: true,
            });
            break;

          case (261, 262):
            this.setState({
              isNewDeliveryTermDisabled: true,
            });
            break;

          case (265, 267, 268):
            this.setState({
              isEditDeliveryTermDisabled: true,
            });
            break;

          case (263, 264):
            this.setState({
              isDeleteDeliveryTermDisabled: true,
            });
            break;

          case 461:
            this.setState({
              isPrintDeliveryTermDisabled: true,
            });
            break;

          case 462:
            this.setState({
              isExcelDeliveryTermDisabled: true,
            });
            break;
          ...
          case (271, 272):
            this.setState({
              isNewShippingMethodDisabled: true,
            });
            break;

          case (276, 277, 278):
            this.setState({
              isEditShippingMethodDisabled: true,
            });
            break;

          case (273, 275):
            this.setState({
              isDeleteShippingMethodDisabled: true,
            });
            break;

          case 463:
            this.setState({
              isPrintShippingMethodDisabled: true,
            });
            break;

          case 464:
            this.setState({
              isExcelShippingMethodDisabled: true,
            });
            break;

          case (279, 280):
            this.setState({
              isResponsibleTypeDisabled: true,
            });
            break;

          case (281, 282):
            this.setState({
              isNewResponsibleTypeDisabled: true,
            });
            break;

          case (285, 286, 287):
            this.setState({
              isEditResponsibleTypeDisabled: true,
            });
            break;

          case (283, 284):
            this.setState({
              isDeleteResponsibleTypeDisabled: true,
            });
            break;

          case 465:
            this.setState({
              isPrintResponsibleTypeDisabled: true,
            });
            break;

          case 466:
            this.setState({
              isExcelResponsibleTypeDisabled: true,
            });
            break;

          case (288, 289):
            this.setState({
              isTaskStatusDisabled: true,
            });
            break;

          case (290, 291):
            this.setState({
              isNewTaskStatusDisabled: true,
            });
            break;

          case (294, 295, 296):
            this.setState({
              isEditTaskStatusDisabled: true,
            });
            break;

          case (292, 293):
            this.setState({
              isDeleteTaskStatusDisabled: true,
            });
            break;

          case 467:
            this.setState({
              isPrintTaskStatusDisabled: true,
            });
            break;

          case 468:
            this.setState({
              isExcelTaskStatusDisabled: true,
            });
            break;
          ...
          case (299, 300):
            this.setState({
              isNewReportTypeDisabled: true,
            });
            break;

          case (303, 304, 305):
            this.setState({
              isEditReportTypeDisabled: true,
            });
            break;

          case (301, 302):
            this.setState({
              isDeleteReportTypeDisabled: true,
            });
            break;

          case 469:
            this.setState({
              isPrintReportTypeDisabled: true,
            });
            break;

          case 470:
            this.setState({
              isExcelReportTypeDisabled: true,
            });
            break;

          case 8:
            this.setState({
              isCRMSettingDisabled: true,
            });
            break;
          ...
          case (308, 309):
            this.setState({
              isNewRatingDisabled: true,
            });
            break;

          case (312, 313, 314):
            this.setState({
              isEditRatingDisabled: true,
            });
            break;

          case (310, 311):
            this.setState({
              isDeleteRatingDisabled: true,
            });
            break;

          case 471:
            this.setState({
              isPrintRatingDisabled: true,
            });
            break;

          case 472:
            this.setState({
              isExcelRatingDisabled: true,
            });
            break;

          case (315, 316):
            this.setState({
              isAccountSourceDisabled: true,
            });
            break;

          case (317, 318):
            this.setState({
              isNewAccountSourceDisabled: true,
            });
            break;

          case (321, 322, 323):
            this.setState({
              isEditAccountSourceDisabled: true,
            });
            break;

          case (319, 320):
            this.setState({
              isDeleteAccountSourceDisabled: true,
            });
            break;

          case 473:
            this.setState({
              isPrintAccountSourceDisabled: true,
            });
            break;

          case 474:
            this.setState({
              isExcelAccountSourceDisabled: true,
            });
            break;

          case (342, 343):
            this.setState({
              isCRMTaskStatusDisabled: true,
            });
            break;

          case (344, 345):
            this.setState({
              isNewCRMTaskStatusDisabled: true,
            });
            break;

          case (349, 350, 351):
            this.setState({
              isEditCRMTaskStatusDisabled: true,
            });
            break;

          case (346, 347):
            this.setState({
              isDeleteCRMTaskStatusDisabled: true,
            });
            break;

          case 475:
            this.setState({
              isPrintCRMTaskStatusDisabled: true,
            });
            break;

          case 476:
            this.setState({
              isExcelCRMTaskStatusDisabled: true,
            });
            break;

          case (324, 325):
            this.setState({
              isCRMResponsibleTypeDisabled: true,
            });
            break;

          case (326, 327):
            this.setState({
              isNewCRMResponsibleTypeDisabled: true,
            });
            break;

          case (330, 331, 332):
            this.setState({
              isEditCRMResponsibleTypeDisabled: true,
            });
            break;

          case (328, 329):
            this.setState({
              isDeleteCRMResponsibleTypeDisabled: true,
            });
            break;

          case 477:
            this.setState({
              isPrintCRMResponsibleTypeDisabled: true,
            });
            break;

          case 478:
            this.setState({
              isExcelCRMResponsibleTypeDisabled: true,
            });
            break;

          case (333, 334):
            this.setState({
              isCRMReportTypeDisabled: true,
            });
            break;

          case (335, 336):
            this.setState({
              isNewCRMReportTypeDisabled: true,
            });
            break;

          case (339, 340, 341):
            this.setState({
              isEditCRMReportTypeDisabled: true,
            });
            break;

          case (337, 338):
            this.setState({
              isDeleteCRMReportTypeDisabled: true,
            });
            break;

          case 479:
            this.setState({
              isPrintCRMReportTypeDisabled: true,
            });
            break;

          case 480:
            this.setState({
              isExcelCRMReportTypeDisabled: true,
            });
            break;

          case 7:
            this.setState({
              isMarketingSettingDisabled: true,
            });
            break;

          case (539, 542, 543, 544, 545, 547, 595):
            this.setState({
              isQuoteTimelineDisabled: true,
            });
            break;

          case (540, 549, 550, 551):
            this.setState({
              isNewQuoteTimelineDisabled: true,
            });
            break;

          case (541, 552):
            this.setState({
              isDeleteQuoteTimelineDisabled: true,
            });
            break;

          case (582, 583, 584, 585, 586, 587, 592):
            this.setState({
              isOrderTimelineDisabled: true,
            });
            break;

          case (590, 594):
            this.setState({
              isNewOrderTimelineDisabled: true,
            });
            break;

          case (591, 593):
            this.setState({
              isDeleteOrderTimelineDisabled: true,
            });
            break;

          case (502, 619, 620):
            this.setState({
              isMergeOrderToOrderDisabled: true,
            });
            break;

          case (503, 621, 622):
            this.setState({
              isSplitOrderToOrderDisabled: true,
            });
            break;

          case (501, 636, 637):
            this.setState({
              isCorrespondingOrderToOrderDisabled: true,
            });
            break;

          case (499, 634, 635):
            this.setState({
              isMergeOrderToQuoteDisabled: true,
            });
            break;
          ...
          case (641, 583, 645, 646, 647, 648, 649):
            this.setState({
              isInvoiceTimelineDisabled: true,
            });
            break;

          case (642, 650, 651, 652):
            this.setState({
              isNewInvoiceTimelineDisabled: true,
            });
            break;

          case (643, 644):
            this.setState({
              isDeleteInvoiceTimelineDisabled: true,
            });
            break;

          case (672, 673):
            this.setState({
              isCorrespondingInvoiceToInvoiceDisabled: true,
            });
            break;

          case (697, 698, 699):
            this.setState({
              isInvoiceRequisitionDisabled: true,
            });
            break;

          case (680, 681, 682):
            this.setState({
              isMergeInvoiceToOrderDisabled: true,
            });
            break;

          case (677, 678, 679):
            this.setState({
              isSplitInvoiceToOrderDisabled: true,
            });
            break;

          case (674, 675, 676):
            this.setState({
              isConvertInvoiceToOrderDisabled: true,
            });
            break;

          case (683, 684):
            this.setState({
              isCorrespondingInvoiceToOrderDisabled: true,
            });
            break;
          ...
          case (702, 703):
            this.setState({
              isReasonsSalesReturnDisabled: true,
            });
            break;

          case (704, 705):
            this.setState({
              isNewReasonsSalesReturnDisabled: true,
            });
            break;

          case (706, 707, 708):
            this.setState({
              isEditReasonsSalesReturnDisabled: true,
            });
            break;

          case (709, 710):
            this.setState({
              isDeleteReasonsSalesReturnDisabled: true,
            });
            break;

          case 711:
            this.setState({
              isPrintReasonsSalesReturnDisabled: true,
            });
            break;

          case 712:
            this.setState({
              isExcelReasonsSalesReturnDisabled: true,
            });
            break;
          ...
          756,757,758,759,760,761,762,763,764,765,766,767,768,769,770,771,772,773,774,775,776):
            this.setState({
              isNewSalesReturnDisabled: true,
              isEditSalesReturnDisabled: true,
            });
            break;
          ...
          case (716,734):
            this.setState({
              isDeleteSalesReturnDisabled: true,
            });
            break;
          ...
          case (717, 718):
            this.setState({
              isManualActivityTypeDisabled: true,
            });
            break;

          case (720, 721):
            this.setState({
              isNewManualActivityTypeDisabled: true,
            });
            break;

          case (722, 723, 724):
            this.setState({
              isEditManualActivityTypeDisabled: true,
            });
            break;

          case (725, 726):
            this.setState({
              isDeleteManualActivityTypeDisabled: true,
            });
            break;

          case (727):
            this.setState({
              isPrintManualActivityTypeDisabled: true,
            });
            break;
          ...
          case (728):
            this.setState({
              isExcelManualActivityTypeDisabled: true,
            });
            break;
    ...
    switch (key) {
      ...
      case "managementCartable":
        if (e === true) {
          ...
          await this.postRolePermission(true);
          this.setState({
          ...
          this.state.sourceList.push({ sourceId: 1 });
          await this.postRolePermission(false);
          this.setState({
            isManagementCartableChecked: e,
      ...
      case "salesReturn":
        if (e === true) {
          this.state.sourceList.push({ sourceId: 713 },    { sourceId: 729 },
            { sourceId: 730 },
            { sourceId: 731 },
            { sourceId: 732 },
            { sourceId: 733 },
      ...
      case "materialMenu":
        if (e === true) {
          ...
          this.state.sourceList.push({ sourceId: 6 }, { sourceId: 7 });
      ...
      case "materialCard":
        if (e === true) {
          ...
          // const filteredItems = items.filter(item => !removedItem.includes(item.sourceId));
          for (let index = 791; index < 829; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
      ...
      case "newMaterial":
        if (e === true) {
          for (let index = 795; index < 809; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          this.state.sourceList.push( { sourceId: 913 });
          await this.postRolePermission(true);
          this.setState({
      ...
      case "deleteMaterial":
        if (e === true) {
          ...
          // const filteredItems = items.filter(item => !removedItem.includes(item.sourceId));
          this.state.sourceList.push({ sourceId: 111 }, { sourceId: 112 });
          await this.postRolePermission(false);
          this.setState({
            //sourceList: filteredItems,
            //
      ...
      case "newMaterialCategory":
        if (e === true) {
          for (let index = 782; index < 785; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "editMaterialCategory":
        if (e === true) {
          for (let index = 787; index < 791; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "newScale":
        if (e === true) {
          for (let index = 830; index < 833; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "editScale":
        if (e === true) {
          for (let index = 835; index < 839; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "newProductCategory":
        if (e === true) {
          for (let index = 852; index < 856; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "editProductCategory":
        if (e === true) {
          for (let index = 858; index < 861; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "newSupplyChain":
        if (e === true) {
          for (let index = 841; index < 844; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
      ...
      case "editSupplyChain":
        if (e === true) {
          for (let index = 846; index < 850; index++) {
            this.state.sourceList.push({ sourceId: index });
          }
          await this.postRolePermission(true);
          this.setState({
  ...
  postRolePermission = async (statusFlag) => {
    let data = {
      roleRef: this.props.roleId,
      sourceList: this.state.sourceList,
      statusFlag: statusFlag,
    };

    await this.props.postRolePermission(JSON.stringify(data));
  };
  /* #endregion */
                ...
                >
                  ...
                  >
                    ...
                    >
                      سند متناظر
                      <Switch
                        checked={this.state.isCorrespondingInvoiceToInvoiceChecked}
                        disabled={this.state.isCorrespondingInvoiceToInvoiceDisabled}
                        onChange={(e) => {
                    ...
                    >
                      سند متناظر به سفارش
                      <Switch
                        checked={this.state.isCorrespondingInvoiceToOrderChecked}
                        disabled={this.state.isCorrespondingInvoiceToOrderDisabled}
                        onChange={(e) => {
              ...
              >
                ...
                >
                  ...
                  <Switch
                    ...
                    onChange={(e) => {
                      this.handleChange(e, "materialCategory");
                    }}
                    className="switch"
                  />
                  <div
...
const mapStateToProps = (state) => {
  return {
    ...
    roleParentId: state.account.roleParentId,
    rolePermissionList: state.account.rolePermissionList,
    roleNotPermissionList: state.account.roleNotPermissionList,
...
const mapDispatchToProps = (dispatch) => ({
  ...
  postRolePermission: (data) => dispatch(postRolePermission(data)),
});
/* #endregion */
