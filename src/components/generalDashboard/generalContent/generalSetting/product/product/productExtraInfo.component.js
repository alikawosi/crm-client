...
import { getProductExtraInformation, postProductExtraInformation, deleteProductExtraInformation, resetProps } from '../../../../../../redux/product/product/product.action';
...
class ExtraInformation extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            infoValueType: 'text',
            isExtraInfoFormHidden:false,
            isExtraInfoHeaderHidden:true,
            /* #endregion */
    ...
    componentDidMount() {
        ...
        if (this.props.mainGridCalling){
            this.setState({
                isExtraInfoFormHidden:true,
                isExtraInfoHeaderHidden:false
            })
        }
        this.getProductExtraInformation();
    }
    /* #endregion */
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.productExtraInformationList !== prevProps.productExtraInformationList) {
            this.setState({
                rowData: this.props.productExtraInformationList
            })
        }
...
//#endregion
    ...
    save = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postProductExtraInformation();
            this.resetForm();
        }
    }
    /* #endregion */
    ...
    delete = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteProductExtraInformation();
        await this.getProductExtraInformation();
        this.resetForm();
    }
    /* #endregion */
    ...
    getProductExtraInformation = async () => {
        let productExrtaInformationGetData = {
            productRef: this.props.productId
        }
        await this.props.getProductExtraInformation(productExrtaInformationGetData);
    }
    /* #endregion */
    ...
    postProductExtraInformation = async () => {
        let productExtraInformationPostData = {
            productRef: this.props.productId,
        ...
        await this.props.postProductExtraInformation(productExtraInformationPostData);
    }
    /* #endregion */

    /* #region  [- deleteProductExtraInformation() -] */
    deleteProductExtraInformation = async () => {
        let quoteExtraInformationDeleteData = {
            productRef: this.props.productId,
            productExtraInformationIdList: [
                {
                    id: this.state.id
                }
            ]
        }
        await this.props.deleteProductExtraInformation(quoteExtraInformationDeleteData);
    }
    /* #endregion */
    ...
    render() {
        ...
        return (
            <Container fluid style={{ padding: '0 2% 4% 0' }}>
                ...
                <Row title='header' className='mt-2' hidden={this.state.isExtraInfoHeaderHidden}>
                    <Col style={{ direction: 'rtl', textAlign: 'right' }}>
                        <span style={{ height: '48px', lineHeight: '48px', fontSize: '25px' }}>اطلاعات بیشتر</span>
                    </Col>
                    <hr />
                </Row>
                ...
                <Row name='row_01_Form'>
                    <Col sm='12' md='12' lg='12' style={{ textAlign: 'right' }}>
                        <Form style={{ padding: '1%' }} hidden={this.state.isExtraInfoFormHidden}>
                            <br />
                ...
                <Row name='row_02_Buttons' hidden={this.state.isExtraInfoFormHidden}>
                ...
                <Row name='row_03_Grid'>
                    ...
                    <Col className="ag-theme-alpine mt-2" style={{ height: '40vh', width: '100%', margin:'2%' }}>
                        <AgGridReact
...
const mapStateToProps = state => {
    return {
        ...
        extraInfoFieldTypeList: state.product.extraInfoFieldTypeList,
        productExtraInformationList: state.product.productExtraInformationList,
...
const mapDispatchToProps = dispatch => ({
    getProductExtraInformation: (data) => dispatch(getProductExtraInformation(data)),
    postProductExtraInformation: (data) => dispatch(postProductExtraInformation(data)),
    deleteProductExtraInformation: (data) => dispatch(deleteProductExtraInformation(data)),
