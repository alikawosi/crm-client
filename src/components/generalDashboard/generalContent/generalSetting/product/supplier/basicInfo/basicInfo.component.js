...
/* #region  [- componentDidMount() -] */
    ...
    componentDidMount(){
        ...
        if (this.props.editMode === true) {
            const supplierItem = Object.assign({}, this.props.supplierItem[0]);
      
            this.setState({
                id: supplierItem.id,
                code:supplierItem.code,
                abbreviation:supplierItem.abbreviation,
                descriptionRow:supplierItem.descriptionRow,
            })

            if (supplierItem.personRef===null) {
                this.setState({
                    organizationRef:supplierItem.organizationRef,
                    isLegalPersonSelected:true,
                    isRealPersonSelected:false,
                    personRef:''
                })
            ...
            else if(supplierItem.organizationRef===null) {
                this.setState({
                    personRef:supplierItem.personRef,
...
/* #region  [- getSupplyChainFormData -] */
    ...
    let supplierBasicInfoFormGetData = {
        domainRef: parseInt(this.props.domain)
        }
    await this.props.getSupplyChainFormData(supplierBasicInfoFormGetData)
    }
                    ...
                    <Col sm='12'>
                        <Form>
                            <Row style={{ paddingTop: "4%" }}>
                                <Col sm='12'>
                                    <FormGroup name='supplierType' style={{ paddingRight:'2%',textAlign: "right" }}>
                                        <Row>
                                            ...
                                            onChange={this.supplierTypeSelector}
                                            />
                                        </Row>
                                        <Row>
                                    ...
                                    <FormGroup name='legalsupplier' hidden={this.state.isRealPersonSelected} style={{ textAlign: "right" }}>
                                        ...
                                        <Col  hidden ={true} name="quickAccess" sm='1' style={{ padding: '0' }}>
                                            <PlusSquareOutlined
                                            disabled={true}
                                            style={{
                                                fontSize: "30px",
                                    ...
                                    <FormGroup name='realsupplier' hidden={this.state.isLegalPersonSelected} style={{ textAlign: "right" }}>
