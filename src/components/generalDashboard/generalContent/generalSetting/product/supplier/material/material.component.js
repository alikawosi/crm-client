...
/* #endregion */
    ...
    async componentDidMount() {
        ...
        await this.getSupplierMaterial();
    ...
    /* #region  [- getSupplierMaterial() -] */
    getSupplierMaterial = async () => {
        let producerMaterialGetData = {
            supplyChainId: this.props.supplierId
        }
                ...
                <Row name='grid' style={{ marginTop:'10px', marginBottom:'10px' }}>
                    ...
                    <Col key='agGrid' className='ag-theme-alpine' style={{ height: '40vh', width: '100%' }}>
                        <AgGridReact
                            gridOptions={this.state.gridOptions}
                            columnDefs={this.state.columnDefs}
                            rowData={this.props.supplierMaterialList}
                            enableRtl={true}
                            onGridReady={this.onGridReady}
                            rowSelection='single'
                            onSelectionChanged={this.onSelectionChanged}
...
const mapStateToProps = state => {
    return {
        ...
        supplierMaterialList: state.producer.producerMaterialList,
