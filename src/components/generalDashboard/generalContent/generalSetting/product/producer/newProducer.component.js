    ...
    saveAndContinue = async () => {
        ...
        if (this.state.currentStep === 0) {
            ...
            if (result === true) {
                           this.setState({
                currentStep: 1,
                stepContent: <Material producerId={this.props.insertedProducerId} />,
                //flags
            ...
            <Container fluid style={{ height: '100vh' }}>
                ...
                <Row title='content' style={{ height: '89vh' }}>
                    <Col title='steps' sm='4' style={{ borderLeft: '1px solid #f0f0f0', paddingTop: '10%' }}>
                        <Steps direction="vertical" current={this.state.currentStep} onChange={this.onChangeStep}>
                            ...
                            <Step title="انتخاب کالا پایه  " disabled={true} hidden={true} />
                        </Steps>
                    </Col>
                ...
                <Row title='buttons' style={{ height: '6vh', borderTop: '1px solid #f0f0f0' }}>
                    <Col sm='12' style={{ lineHeight: '6vh' }}>
                        ...
                        <Button className='submit-button-style mr-2' onClick={this.saveAndContinue} hidden={true}>
                            ذخیره و ادامه
                        </Button>
...
const mapStateToProps = state => {
    return {
        insertedProducerId: state.supplyChain.insertedSupplyChainId,
