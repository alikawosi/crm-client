...
import { resetProps, getTaskStatus, deleteTaskStatus, postTaskStatus, getTaskStatusItem } from '../../../../../../redux/crm/taskStatus/crmTaskStatus.action'
...
class TaskStatus extends PureComponent {
    ...
    /* #region  [- accessToMenu -] */
    accessToMenu = (data) => {
        if (data.includes("344")) {
            this.setState({
                isNewButtonHidden: false
            })
        }
        if (data.includes("349")) {
            this.setState({
        ...
        if (data.includes("475")) {
            this.setState({
                isPrintButtonHidden: false
            })
        }
        if (data.includes("476")) {
            this.setState({
...
const mapStateToProps = state => {
    return {
        ...
        message: state.crmTaskStatus.message,
        taskStatusList: state.crmTaskStatus.taskStatusList,
