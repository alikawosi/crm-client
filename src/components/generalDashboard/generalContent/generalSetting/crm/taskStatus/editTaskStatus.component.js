...
import { putTaskStatus } from '../../../../../../redux/crm/taskStatus/crmTaskStatus.action';
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">وضعیت کار گزارش</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        taskStatusItem: state.crmTaskStatus.taskStatusItem
    };
};
/* #endregion */
