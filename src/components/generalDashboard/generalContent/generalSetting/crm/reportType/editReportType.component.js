...
import { putReportType } from '../../../../../../redux/crm/reportType/crmReportType.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class EditReportType extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.reportTypeItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putReportType = async () => {
        ...
        await this.props.putReportType(JSON.stringify(reportTypePutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش نوع گزارش</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        reportTypeItem: state.crmReportType.reportTypeItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putReportType: (data) => dispatch(putReportType(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditReportType);
