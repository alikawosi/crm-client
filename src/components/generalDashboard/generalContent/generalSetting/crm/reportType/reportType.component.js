...
import { resetProps, getReportType, deleteReportType, postReportType, getReportTypeItem } from '../../../../../../redux/crm/reportType/crmReportType.action'
...
class ReportType extends PureComponent {
    ...
    /* #endregion */
     ...
     /* #region  [- accessToMenu -] */
     accessToMenu = (data) => {
        if (data.includes("335")) {
            this.setState({
                isNewButtonHidden: false
            })
        }
        if (data.includes("339")) {
            this.setState({
                isEditButtonHidden: false
            })
        }
        if (data.includes("337")) {
            this.setState({
        ...
        if (data.includes("479")) {
            this.setState({
                isPrintButtonHidden: false
            })
        }
        if (data.includes("480")) {
            this.setState({
            ...
            <Container fluid className='reacstrap-container' style={{ padding: '0' }} >
                        ...
                        <Row name='row_02_Header' className='content-header-row' style={{ margin: '0 0 1% 0', padding: '0' }}>
                            ...
                            <Col className='content-header-col'>
                                <p className='content-header-title'>نوع گزارش</p>
                            </Col>
...
const mapStateToProps = state => {
    return {
        ...
        message: state.crmReportType.message,
        reportTypeList: state.crmReportType.reportTypeList,
