...
import { putAccountSource } from '../../../../../../redux/crm/accountSource/accountSource.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class EditAccountSource extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.accountSourceItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putAccountSource = async () => {
        let accountSourcePutData = {
            id: this.state.id,
        ...
        await this.props.putAccountSource(JSON.stringify(accountSourcePutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش منابع</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        accountSourceItem: state.accountSource.accountSourceItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putAccountSource: (data) => dispatch(putAccountSource(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditAccountSource);
