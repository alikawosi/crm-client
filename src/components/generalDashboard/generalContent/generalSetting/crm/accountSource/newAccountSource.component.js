...
import { postAccountSource } from '../../../../../../redux/crm/accountSource/accountSource.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class NewAccountSource extends PureComponent {
            ...
            <Container fluid  className="reacstrap-container" style={{padding:"0"}} >
                            ...
                            <Row  name='row_01_Header' className='form-header-row' style={{margin:"0"}}>
                                <Col className="form-header-col">
                                    <p className="form-header-title">منابع جدید</p>
                                </Col>
                            </Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(NewAccountSource);
