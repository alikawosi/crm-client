...
import { resetProps, getResponsibleType, deleteResponsibleType, postResponsibleType, getResponsibleTypeItem } from '../../../../../../redux/crm/responsibleType/crmResponsibleType.action'
import NewResponsibleType from './newResponsibleType.component'
import EditResponsibleType from './editResponsibleType.component';
/* #endregion */

class ResponsibleType extends PureComponent {
    ...
    /* #endregion */
     ...
     /* #region  [- accessToMenu -] */
     accessToMenu = (data) => {
        if (data.includes("326")) {
            this.setState({
                isNewButtonHidden: false
            })
        }
        if (data.includes("330")) {
            this.setState({
                isEditButtonHidden: false
            })
        }
        if (data.includes("328")) {
            this.setState({
        ...
        if (data.includes("477")) {
            this.setState({
                isPrintButtonHidden: false
            })
        }
        if (data.includes("478")) {
            this.setState({
    ...
    componentDidUpdate(prevProps) {
        ...
        this.setState({
            rowData: this.props.responsibleTypeList
        })
    }
    /* #endregion */
  ...
  /* #endregion */
    ...
    getResponsibleType = async () => {
        let responsibleTypeData = {
            domainRef: this.props.domain
        }
        await this.props.getResponsibleType(JSON.stringify(responsibleTypeData));
    }
    /* #endregion */

    /* #region  [- getResponsibleTypeItem -] */
    getResponsibleTypeItem = async () => {
        let responsibleTypeItemData = {
            id: this.state.id
        }
        await this.props.getResponsibleTypeItem(JSON.stringify(responsibleTypeItemData));
    }
    /* #endregion */

    /* #region  [- deleteResponsibleType -] */
    deleteResponsibleType = async () => {
        let responsibleTypeDeleteData = {
            domainRef: this.props.domain,
            responsibleTypeIdList: [{
                id: this.state.id
            }]
        }
        await this.props.deleteResponsibleType(JSON.stringify(responsibleTypeDeleteData));
    }
    /* #endregion */

    /* #region  [- postExcelFile -] */
    postExcelFile = async (excelData) => {
        let responsibleTypePostData = {
            domainRef: this.props.domain,
            responsibleTypeList: excelData
        }
        await this.props.postResponsibleType(JSON.stringify(responsibleTypePostData));
    }
    /* #endregion */
    ...
    new = async () => {
        ...
        this.setState({
            ...
            newDrawerContent: <NewResponsibleType onClose={this.onCloseNewDrawer} />
        });
    }
    /* #endregion */
    ...
    edit = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.getResponsibleTypeItem();
        this.setState({
            isEditDrawerVisible: true,
            editDrawerContent: <EditResponsibleType onClose={this.onCloseEditDrawer} />
        });
    ...
    deleteInModal = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteResponsibleType();
            ...
            <Container fluid className='reacstrap-container' style={{ padding: '0' }} >
                        ...
                        <Row name='row_02_Header' className='content-header-row' style={{ margin: '0 0 1% 0', padding: '0' }}>
                            ...
                            <Col className='content-header-col'>
                                <p className='content-header-title'>نوع مسئولیت</p>
                            </Col>
                        ...
                        <Row name='row_05_DrawersAndModals'>
                            ...
                            >
                                <Container fluid>
                                    ...
                                    <Row name='content'>
                                        <Col sm='12' >
                                            <ExcelImport name='responsibleType' sendExcelFileList={this.postExcelFile} columnsDef={this.state.columns} onRef={ref => (this.child = ref)} />
                                        </Col>
                                    </Row>
                                </Container>
                            </Modal>
...
const mapStateToProps = state => {
    return {
        ...
        message: state.crmResponsibleType.message,
        responsibleTypeList: state.crmResponsibleType.responsibleTypeList,
...
const mapDispatchToProps = dispatch => ({
    ...
    getResponsibleType: (data) => dispatch(getResponsibleType(data)),
    deleteResponsibleType: (data) => dispatch(deleteResponsibleType(data)),
    postResponsibleType: (data) => dispatch(postResponsibleType(data)),
    getResponsibleTypeItem: (data) => dispatch(getResponsibleTypeItem(data)),
})
/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(ResponsibleType);
