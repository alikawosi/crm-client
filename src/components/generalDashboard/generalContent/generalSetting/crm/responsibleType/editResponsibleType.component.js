...
import { putResponsibleType } from '../../../../../../redux/crm/responsibleType/crmResponsibleType.action';
import { checkTokenExpiration } from '../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class EditResponsibleType extends PureComponent {
    ...
    /* #region  [- loadForm -] */
    loadForm = async () => {
        let data = { ...this.props.responsibleTypeItem[0] }
        await this.setState({
            id: data.id,
            title: data.title,
    ...
    putResponsibleType = async () => {
        let responsibleTypePutData = {
            id: this.state.id,
        ...
        await this.props.putResponsibleType(JSON.stringify(responsibleTypePutData));
    }
    /* #endregion */
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                        ...
                        <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                            <Col className="form-header-col">
                                <p className="form-header-title">ویرایش نوع مسئولیت</p>
                            </Col>
                        </Row>
...
const mapStateToProps = state => {
    return {
        ...
        responsibleTypeItem: state.crmResponsibleType.responsibleTypeItem
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    putResponsibleType: (data) => dispatch(putResponsibleType(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(EditResponsibleType);
