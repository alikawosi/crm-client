...
import { getSalesReturnExtraInformation, postSalesReturnExtraInformation, deleteSalesReturnExtraInformation, } from '../../../../../../../redux/sales/invoice/salesReturn/salesReturn.action';
...
class ExtraInformation extends PureComponent {
    ...
    componentDidMount() {
        this.getSalesReturnExtraInformation();
    }
    /* #endregion */
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.salesReturnExtraInformationList !== prevProps.salesReturnExtraInformationList) {
            this.setState({
                rowData: this.props.salesReturnExtraInformationList
            })
        }
...
//#endregion
    ...
    save = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postSalesReturnExtraInformation();
            this.resetForm();
        }
    }
    /* #endregion */
    ...
    delete = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteSalesReturnExtraInformation();
        this.resetForm();
    }
    /* #endregion */
    ...
    getSalesReturnExtraInformation = async () => {
        let salesReturnExrtaInformationGetData = {
            salesReturnHeaderRef: this.props.salesReturnInsertedId
        }
        await this.props.getSalesReturnExtraInformation(salesReturnExrtaInformationGetData);
    }
    /* #endregion */
    ...
    postSalesReturnExtraInformation = async () => {
        let salesReturnExtraInformationPostData = {
            salesReturnHeaderRef: this.props.salesReturnInsertedId,
        ...
        await this.props.postSalesReturnExtraInformation(salesReturnExtraInformationPostData);
    }
    /* #endregion */

    /* #region  [- deleteSalesReturnExtraInformation() -] */
    deleteSalesReturnExtraInformation = async () => {
        let salesReturnExtraInformationDeleteData = {
            salesReturnHeaderRef: this.props.salesReturnInsertedId,
            salesReturnExtraInformationIdList: [
                {
                    id: this.state.id
                }
            ]
        }
        await this.props.deleteSalesReturnExtraInformation(salesReturnExtraInformationDeleteData);
    }
    /* #endregion */
...
const mapStateToProps = state => {
    return {
        ...
        extraInfoFieldTypeList: state.salesReturn.extraInfoFieldTypeList,
        salesReturnExtraInformationList: state.salesReturn.salesReturnExtraInformationList,
...
const mapDispatchToProps = dispatch => ({
    getSalesReturnExtraInformation: (data) => dispatch(getSalesReturnExtraInformation(data)),
    postSalesReturnExtraInformation: (data) => dispatch(postSalesReturnExtraInformation(data)),
    deleteSalesReturnExtraInformation: (data) => dispatch(deleteSalesReturnExtraInformation(data)),
