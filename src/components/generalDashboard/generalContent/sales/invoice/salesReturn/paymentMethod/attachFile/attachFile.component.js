...
class AttachFile extends PureComponent {
  ...
  componentDidMount() {
    let list = [...this.props.salesReturnPaymentMethodAttachedFileList]
    this.setState({
      rowData: list,
    ...
    return (
      ...
      <Container >
        ...
        <Row name='row_04_SubmitCancel' style={{ paddingTop: '2%' }}>
          ...
          <Col sm="3" name='col-01-Buttons' style={{ direction: 'ltr', paddingLeft: '2%' }}>
          <Button className='submit-button-style mr-2' 
              onClick={this.submit}
              disabled={this.state.isSubmitDisabled} >
              ثبت
           </Button>
            <Button className='cancel-button-style mr-2' onClick={this.props.onCancelAttachFileModal}>
              لغو
            </Button>
