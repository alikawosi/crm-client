...
import { getPaymentMethod, getPaymentMethodData, getPaymentMethodCRMFile, postPaymentMethod, deletePaymentMethod, getSalesReturnPayablePrice, resetProps } from '../../../../../../../redux/sales/paymentMethod/paymentMethod.action'
...
class PaymentMethod extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            salesReturnPaymentMethodAttachedFileList: [],
            bankTitleList: [],
            branchTitleList: [],
            idList: [],
    ...
    async componentDidMount() {
        await this.getSalesReturnPayablePrice();
    ...
    submitAttachedFile = (data) => {
        this.setState({
            salesReturnPaymentMethodAttachedFileList: data,
    ...
    setFormInputHiddenStatus = () => {
        let result = this.state.isCheckFlagChecked
        if (result === true) {
            return false
        }
    ...
    setTitleInputHiddenStatus = () => {
        if (this.state.isInstallmentFlagChecked === true) {
            return false;
        }
        else {
            return true;
    ...
    postPaymentMethod = async () => {
        ...
        let list = [{
            ...
            guaranteeOtherPaymentFlag: false,
        ...
        let data =
        {
            ...
            paymentMethodCRMFileList: this.state.salesReturnPaymentMethodAttachedFileList,
        }
    ...
    getSalesReturnPayablePrice = async () => {
        let data = {
            salesReturnHeaderRef: this.props.salesReturnInsertedId,
        }
        await this.props.getSalesReturnPayablePrice(JSON.stringify(data));
    }
    /* #endregion */
                ...
                <Row name='row_01_Form'>
                    <Col sm='12' style={{ textAlign: 'right' }}>
                        <Form style={{ padding: '1%' }}>
                            ...
                            <FormGroup name='radioButtons' style={{ paddingRight: '4%', marginBottom: '4%' }}>
                                ...
                                <FormGroup name='radioButtonsMonetary' style={{ paddingRight: '2%' }} hidden={!this.state.isMonetaryFlagChecked}>
                                    ...
                                    <Label name="check" check>
                                        ...
                                        <Input
                                            ...
                                            name="radioButtonsMonetary"
                                            checked={false}
                                            disabled={true} />مبادله کالا</Label>
                                </FormGroup>
                                    ...
                                    <Col sm='6'>
                                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center' }} >
                                            <thead>
                                                ...
                                                <tr>
                                                    <td>{this.props.salesReturnPayablePrice.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}</td>
                                                    <td>{this.state.totalMonetaryPrice.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}</td>
                                                    <td>{((this.props.salesReturnPayablePrice * 1) - this.state.totalMonetaryPrice).toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}</td>
                                                </tr>
                        ...
                        <Container fluid>
                            ...
                            <Row name='content' style={{ marginBottom: '3%' }}>
                                <AttachFile
                                    ...
                                    salesReturnPaymentMethodAttachedFileList={this.state.salesReturnPaymentMethodAttachedFileList}
...
const mapStateToProps = state => {
    return {
        ...
        salesReturnPayablePrice: state.paymentMethod.salesReturnPayablePrice,
    }
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    getSalesReturnPayablePrice: (data) => dispatch(getSalesReturnPayablePrice(data)),
});
/* #endregion */
