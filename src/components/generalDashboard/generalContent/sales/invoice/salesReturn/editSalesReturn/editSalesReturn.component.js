...
import { getSeenInvoiceItem, getSalesReturnMaxOrdinalCode, saveSalesReturnBasicInfo, putSalesReturn } from '../../../../../../../redux/sales/invoice/salesReturn/salesReturn.action';
...
class EditSalesReturn extends PureComponent {
    ...
    componentDidMount = async () => {
        let item=this.props.salesReturnItem[0]

        let date = item.latinDateSalesReturn === '' ? dayjs().calendar("jalali").locale("fa") : dayjs(item.latinDateSalesReturn).calendar("jalali").locale("fa")
        ...
        await this.setState({
            ...
            ordinalCode: item.ordinalCode,
            //reducer
            patternCode: year === "" ? this.state.patternCode : year,
            separator: item.separator,
            dateSalesReturn: date === "" ? this.state.dateSalesReturn : date,
            descriptionRow: item.descriptionRow,
            warehouseSalesReturnCode: item.warehouseSalesReturnCode,
            salesReturnAttachedFile: this.props.salesReturnAttachedFile,
            attachedFilesLength: Object.keys(this.props.salesReturnAttachedFile).length,
            isWarehouseSalesReturnCodeValid: this.props.invoiceData.hasRequisitionFlag === true ? true:false,
        })
    ...
    cancel = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.cancelEditSalesReturn()
    }
    /* #endregion */
    ...
    putSalesReturn = async () => {
        ...
        await this.props.putSalesReturn(data)
    };
    /* #endregion */
            ...
            <Container fluid style={{ backgroundColor: 'white' }}>
                ...
                <Row name='row_01_Header' className='mb-2' style={{ borderBottom: '1px solid #f0f0f0', height: '5vh' }}>
                    <Col style={{ direction: 'rtl', textAlign: 'right' }}>
                        <span style={{ height: '48px', lineHeight: '35px', fontSize: '17px', fontWeight: 'bold' }}>ویرایش برگشت از فروش </span>
                    </Col>
                </Row>
...
const mapDispatchToProps = dispatch => ({
    ...
    putSalesReturn: (data) => dispatch(putSalesReturn(data)),
