...
class GridSalesReturnPrintButton extends PureComponent {
    ...
    details = () => {
        ...
        this.props.context.componentParent.printSalesReturn(data);
    }
    /* #endregion */
...
export default connect(mapStateToProps, mapDispatchToProps)(GridSalesReturnPrintButton);
