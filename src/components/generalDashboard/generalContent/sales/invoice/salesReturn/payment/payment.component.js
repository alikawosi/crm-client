...
class Payment extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            salesReturnPaymentAttachedFileList: [],
            bankTitleList: [],
            branchTitleList: [],
            idList: [],
    ...
    submitAttachedFile = (data) => {
        this.setState({
            salesReturnPaymentAttachedFileList: data,
    ...
    postPayment = async () => {
        ...
        let data =
        {
            ...
            typeRef:2*1,
            paymentList: list,
            paymentCRMFileList: this.state.salesReturnPaymentAttachedFileList,
        }
                        ...
                        <Container fluid>
                            ...
                            <Row name='content' style={{ marginBottom: '3%' }}>
                                <AttachFile
                                    ...
                                    salesReturnPaymentAttachedFileList={this.state.salesReturnPaymentAttachedFileList}
