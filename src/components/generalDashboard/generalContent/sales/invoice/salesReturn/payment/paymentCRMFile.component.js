...
class PaymentCRMFile extends PureComponent {
  //#region [- ctor -]
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    let list = [...this.props.paymentCRMFileList]
    this.setState({
      rowData: list,
    })
  }
...
const mapStateToProps = state => {
    return {
        ...
        paymentCRMFileList:state.payment.paymentCRMFileList
    }
};
/* #endregion */


export default connect(mapStateToProps)(PaymentCRMFile);
