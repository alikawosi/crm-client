...
class AttachFile extends PureComponent {
  ...
  componentDidMount() {
    let list = [...this.props.timelineAttachedFileList]
    this.setState({
      rowData: list,
    ...
    return (
      ...
      <Container >
          ...
          <Col name="form">
            <Card name="form">
              <Form style={{ padding: '2%' }}>
                ...
                <FormGroup name="file" style={{ textAlign: 'right' ,fontSize:'15px !important'}}>
        ...
        <Row name='row_04_SubmitCancel' style={{ paddingTop: '2%' }}>
          ...
          <Col sm="12"  md='12' lg='12' name='col-01-Buttons' style={{ direction: 'ltr', paddingLeft: '2%' }}>
          <Button name='submit' className='submit-button-style mr-2'
              onClick={this.submit}
              disabled={this.state.isSubmitDisabled} >
              ثبت
           </Button>
            <Button name='cancel' className='cancel-button-style mr-2' onClick={this.props.onCancelAttachFileModal}>
              لغو
            </Button>
