                ...
                <Row name="row_02_Grid">
                    ...
                    <Col sm="12" md="12" lg="12" className="ag-theme-alpine mt-2" style={{ height: '70vh', width: '100%', marginTop: '2%' }}>
                        <AgGridReact
                            ...
                            columnDefs={this.props.timelineTargetList[0].orderFlag===false?this.state.invoiceColumnDefs:this.state.orderColumnDefs}
...
const mapStateToProps = state => {
    return {
        ...
        timelineTargetList: state.invoiceTimeline.timelineTargetList,
