...
import { getInvoiceExtraInformation, postInvoiceExtraInformation, deleteInvoiceExtraInformation, resetMessage } from '../../../../../../../redux/sales/invoice/invoice/invoice.action';
...
class ExtraInformation extends PureComponent {
    ...
    componentDidMount() {
        this.getInvoiceExtraInformation();
    }
    /* #endregion */
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.invoiceExtraInformationList !== prevProps.invoiceExtraInformationList) {
            this.setState({
                rowData: this.props.invoiceExtraInformationList
            })
        }
...
//#endregion
    ...
    save = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postInvoiceExtraInformation();
            this.resetForm();
        }
    }
    /* #endregion */
    ...
    delete = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteInvoiceExtraInformation();
        this.resetForm();
    }
    /* #endregion */
    ...
    getInvoiceExtraInformation = async () => {
        let invoiceExrtaInformationGetData = {
            invoiceHeaderRef: this.props.invoiceHeaderRef
        }
        await this.props.getInvoiceExtraInformation(invoiceExrtaInformationGetData);
    }
    /* #endregion */
    ...
    postInvoiceExtraInformation = async () => {
        let invoiceExtraInformationPostData = {
            invoiceHeaderRef: this.props.invoiceHeaderRef,
        ...
        await this.props.postInvoiceExtraInformation(invoiceExtraInformationPostData);
    }
    /* #endregion */

    /* #region  [- deleteInvoiceExtraInformation() -] */
    deleteInvoiceExtraInformation = async () => {
        let invoiceExtraInformationDeleteData = {
            invoiceHeaderRef: this.props.invoiceHeaderRef,
            invoiceExtraInformationIdList: [
                {
                    id: this.state.id
                }
            ]
        }
        await this.props.deleteInvoiceExtraInformation(invoiceExtraInformationDeleteData);
    }
    /* #endregion */
...
const mapStateToProps = state => {
    return {
        ...
        extraInfoFieldTypeList: state.invoice.extraInfoFieldTypeList,
        invoiceExtraInformationList: state.invoice.invoiceExtraInformationList,
...
const mapDispatchToProps = dispatch => ({
    getInvoiceExtraInformation: (data) => dispatch(getInvoiceExtraInformation(data)),
    postInvoiceExtraInformation: (data) => dispatch(postInvoiceExtraInformation(data)),
    deleteInvoiceExtraInformation: (data) => dispatch(deleteInvoiceExtraInformation(data)),
