...
import { getOrderOrdinalCodeDuplication, getOrderMaxOrdinalCode, postInvoiceToOrderMerge } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
const mapStateToProps = state => {
    return {
        ...
        invoiceMergedList: state.invoice.invoiceMergedList,
        invoiceMergedProductRefList: state.invoice.quoteMergedProductRefList,
    }
};
/* #endregion */
