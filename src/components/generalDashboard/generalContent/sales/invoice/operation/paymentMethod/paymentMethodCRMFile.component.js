...
import GridFileDownloadButton from './attachFile/gridFileDownloadButton.component'
import { AG_GRID_LOCALE_FA } from "../../../../../../shared/common/agGridLocalization/agGridLocalFA.component";
import { connect } from "react-redux";
/* #endregion */

class PaymentMethodCRMFile extends PureComponent {
  //#region [- ctor -]
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    let list = [...this.props.paymentMethodCRMFileList]
    this.setState({
      rowData: list,
    })
  }
...
const mapStateToProps = state => {
    return {
        ...
        paymentMethodCRMFileList:state.paymentMethod.paymentMethodCRMFileList
    }
};
/* #endregion */


export default connect(mapStateToProps)(PaymentMethodCRMFile);
