...
import { editInvoiceProductAdditions, postInvoiceFinancialCaseType, getInvoiceFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
class Additions extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                pinnedRowCellRenderer: 'customPinnedRowRenderer',valueFormatter: this.currencyFormatter, },
    ...
    submit = () => {
        ...
        let tempList = this.props.invoiceItemProductAdditionsList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
