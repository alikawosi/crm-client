...
import {
    saveInvoiceRegisteredDocumentsProductData, setSaveButtonDisabled,
    ...
    onRowSelected = async (event) => {
        if (this.state.counter === 0) {
            ...
            if (event.node.selected === true) {
                ...
                await this.props.saveInvoiceRegisteredDocumentsProductData(newList);
...
const mapStateToProps = state => {
    return {
        ...
        registeredDocumentsItemProductList: state.invoice.registeredDocumentsItemProductList,
        registeredDocumentsType: state.invoice.registeredDocumentsType,
    }
};
/* #endregion */
