...
import { editInvoiceProductDeductions, postInvoiceFinancialCaseType, getInvoiceFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
class Deductions extends PureComponent {
    ...
    gridLoadData = () => {
        ...
        let list = this.props.invoiceItemProductDeductionsList.filter(x => x.productRef === this.props.productRef)
    ...
    submit = () => {
        ...
        let tempList = this.props.invoiceItemProductDeductionsList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
