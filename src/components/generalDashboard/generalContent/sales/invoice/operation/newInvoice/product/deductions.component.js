...
import { saveInvoiceProductDeductions, postInvoiceFinancialCaseType, getInvoiceFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
class Deductions extends PureComponent {
    ...
    gridLoadData = () => {
        ...
        let list = this.props.invoiceProductDeductionList.filter(x => x.productRef === this.props.productRef)
    ...
    submit = () => {
        ...
        let tempList = this.props.invoiceProductDeductionList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
