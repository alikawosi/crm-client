...
class NewFinancialCaseType extends PureComponent {
    ...
    cancel = async () => {
        ...
        this.props.onCloseNewFinancialCaseTypeDrawer();
    }
    /* #endregion */
                ...
                financialCaseTypeList: [
                    {
                        ...
                        financialCaseFlag: this.props.financialCaseTypeAdditions === true ? false : true,
                        descriptionRow: this.state.descriptionRow
                    }
                ]
            }
            await this.props.postInvoiceFinancialCaseType(financialCaseTypePostData);
            await this.props.getInvoiceFinancialCaseTypeTitle();
        }
            ...
            <Container fluid className='reacstrap-container' style={{ padding: '0' }} >
                ...
                <Row name='row_01_Header' className='form-header-row' style={{ margin: '0' }}>
                    <Col className='form-header-col'>
                        <p className='form-header-title'>{this.props.drawerTitle}</p>
                    </Col>
                </Row>
