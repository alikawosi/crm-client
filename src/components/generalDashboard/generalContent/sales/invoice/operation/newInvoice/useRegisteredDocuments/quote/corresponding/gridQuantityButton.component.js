...
class GridQuantityButton extends PureComponent {
    ...
    gridLoadData = () => {
        if (this.props.sumAllProductQuantity.length !== 0) {
            ...
            let list = this.props.invoiceProductQuantityList.filter(x => x.productRef === this.props.node.data.id)
            ...
            this.setState({
                sumQuantities: this.props.quoteProductList.filter(x => x.id === this.props.node.data.id)[0].quantity,
    ...
    countQuantity = () => {
        let data = {
            ...
            quantity: this.props.quoteProductList.filter(x => x.id === this.props.node.data.id)[0].quantity,
