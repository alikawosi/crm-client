...
import { postOrderToInvoiceCorresponding, getInvoiceInventory } from '../../../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
class Corresponding extends PureComponent {
    ...
    validateFormOnButtonClick = () => {
        ...
        for (let i = 0; i < Object.keys(orderProductList).length; i++) {
            let filteredList = this.props.invoiceProductQuantityList.filter(x => x.productRef === orderProductList[i].id)
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postOrderToInvoiceCorresponding();
    ...
    onCancelProductQuantity = async (productRef) => {
        ...
        let list = [...this.props.orderProductList]
    ...
    postOrderToInvoiceCorresponding = async () => {
        ...
        await this.props.postOrderToInvoiceCorresponding(JSON.stringify(data))
    }
    /* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postOrderToInvoiceCorresponding: (data) => dispatch(postOrderToInvoiceCorresponding(data)),
