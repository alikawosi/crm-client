...
class Order extends PureComponent {
    ...
    split = async () => {
        ...
        await this.props.newOrderToInvoiceSplit(this.state.headerRef, this.state.sellerTitle, this.state.buyerTitle, this.state.latinDateCreated);
    }
    /* #endregion */
    ...
    corresponding = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.newOrderToInvoiceCorresponding(this.state.headerRef);
    }
    /* #endregion */
    ...
    convert = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.newOrderToInvoiceConvert(this.state.headerRef, this.state.latinDateCreated);
    }
    /* #endregion */
    ...
    merge = async () => {
        ...
        if (dateResult === true) {
            ...
            await this.props.newOrderToInvoiceMerge(this.state.mergeHeaderRefList, latinDateCreated);
        }
    }
    /* #endregion */
            ...
            <Container fluid style={{ margin: '0', padding: '0' }}>
                ...
                <Row name="row_01_Buttons" style={{ marginTop: '3%' }}>
                    ...
                    <Col sm="6" style={{ textAlign: 'right' }}>
                        ...
                        <Button key='4' className='submit-button-style mr-2' disabled={this.state.isConvertDisabled} onClick={this.convert} >تبدیل</Button>
                ...
                <Row name='row_02_GridTitle' style={{ marginTop: '2%' }}>
                    <Col sm='4'>
                        <span style={{ fontSize: '15px', fontWeight: '500' }}>لیست سفارش های ثبت شده</span>
                    </Col>
                    <Col sm="8"></Col>
                </Row>
                ...
                <Row name="row_03_Grid" style={{ marginTop: '3%', marginBottom: '1%' }}>
                    ...
                    <Col className="ag-theme-alpine mt-2" style={{ height: '50vh', width: '100%', marginTop: '2%' }}>
                        <AgGridReact
                            ...
                            rowData={this.props.orderListByAccount}
                            enableRtl={true}
...
const mapStateToProps = state => {
    return {
        ...
        orderListByAccount: state.order.orderListByAccount,
    }
};
/* #endregion */
