...
import { saveInvoiceFinancialCase ,postInvoiceFinancialCaseType, getInvoiceFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action';
...
class FinancialCase extends PureComponent {
    ...
    gridLoadData = async () => {
        await this.setState({
            rowData: this.props.invoiceFinancialCaseList,
    ...
    save = async () => {
        if (this.validateFormOnButtonClick() === true) {
            ...
            await this.props.saveInvoiceFinancialCase(this.state.rowData)
            await this.calculateInvoiceTotalPrice()
    ...
    delete = async () => {
        ...
        await this.props.saveInvoiceFinancialCase(list)
        await this.calculateInvoiceTotalPrice()
