...
class Term extends PureComponent {
    ...
    submitAttachedFile = (data) => {
        this.setState({
            invoiceTermAttachedFileList: data,
    ...
    postTerm = async () => {
        ...
        let data =
        {
            ...
            type: 3,
            termList: list,
            termCRMFileList: this.state.invoiceTermAttachedFileList,
        }
                        ...
                        <Container fluid>
                            ...
                            <Row name='content' style={{ marginBottom: '3%' }}>
                                <AttachFile
                                    ...
                                    invoiceTermAttachedFileList={this.state.invoiceTermAttachedFileList}
