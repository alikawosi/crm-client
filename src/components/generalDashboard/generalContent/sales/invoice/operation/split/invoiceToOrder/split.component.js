...
import { postInvoiceToOrderSplit, saveInvoiceToOrderSplitedData } from '../../../../../../../../redux/sales/invoice/invoice/invoice.action'
...
class Split extends PureComponent {
    ...
    resetForm = async () => {
        ...
        let newProductList = [...this.props.invoiceProductList]
    ...
    save = async () => {
        ...
        for (let i = 0; i < Object.keys(selectedData).length; i++) {
            let data = {
                ...
                orderAdditions: selectedData[i].invoiceAdditions,
                orderDeductions: selectedData[i].invoiceDeductions,
        ...
        await this.props.saveInvoiceToOrderSplitedData(data)
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postInvoiceToOrderSplit();
    ...
    onSelectionChangedProduct = () => {
        ...
        if (selectedData.length === 0) {
            ...
            if (selectedData.length === Object.keys(this.props.invoiceProductList).length) {
                this.setState({
                    isValidationModalVisible: true,
    ...
    postInvoiceToOrderSplit = async () => {
        ...
        await this.props.postInvoiceToOrderSplit(JSON.stringify(data))
            ...
            <Container fluid style={{ margin: '0', padding: '0' }}>
                ...
                <Row name='row_02_GridTitle' style={{ paddingRight: '1%' }}>
                    <Col  sm='12' md='12' lg='12'>
                        <span style={{ fontSize: '15px', fontWeight: '500' }}>لیست کالاهای فاکتور مرجع(انتخابی)</span>
                    </Col>
...
const mapStateToProps = state => {
    return {
        ...
        orderProductQuantityList: state.invoice.orderProductQuantityList,
        orderSplitHeaderList: state.invoice.orderSplitHeaderList,
...
const mapDispatchToProps = dispatch => ({
    ...
    postInvoiceToOrderSplit: (data) => dispatch(postInvoiceToOrderSplit(data)),
    saveInvoiceToOrderSplitedData: (data) => dispatch(saveInvoiceToOrderSplitedData(data)),
});
/* #endregion */
