...
class Source extends PureComponent {
    ...
    setColumnDefsValue() {
        if (this.props.timelineSourceList[0].quoteFlag) {     
           return   this.state.quoteColumnDefs    
        }
        else if (this.props.timelineSourceList[0].orderFlag) {
            return   this.state.orderColumnDefs   
        }
        else if (this.props.timelineSourceList[0].invoiceFlag) {
...
const mapStateToProps = state => {
    return {
        ...
        timelineSourceList: state.orderTimeline.timelineSourceList,
