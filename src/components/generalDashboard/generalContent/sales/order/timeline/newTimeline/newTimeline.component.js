...
import { postTimeline, postOrderTimelineManualActivityType } from '../../../../../../../redux/sales/order/timeline/timeline.action'
...
class NewTimeline extends PureComponent {
    ...
    /* #endregion */
        ...
        postTimelineManualActivityType = async (data) => {
            await this.props.postOrderTimelineManualActivityType(JSON.stringify(data));
...
const mapStateToProps = state => {
    return {
        ...
        manualActivityTypeTitleList: state.orderTimeline.manualActivityTypeTitleList,
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postOrderTimelineManualActivityType: (data) => dispatch(postOrderTimelineManualActivityType(data)),
});
