...
class Print extends PureComponent {
    ...
    setOrderItem = async () => {
        ...
        let seller = { ...this.props.orderSellerAndBuyerList.filter(x => x.accountTypeRef === 2)[0] }
        let buyer = { ...this.props.orderSellerAndBuyerList.filter(x => x.accountTypeRef === 1)[0] }
        let code = ''
        ...
        this.setState({
            ...
            nativeDateOrder: orderItem.nativeDateOrder,
            code: code,
            referenceCode: orderItem.referenceCode,
            descriptionRow: orderItem.descriptionRow,
    ...
    calculateOrderTotalPrice = async () => {
        ...
        orderTotalPrice = this.state.productTotalPrice + sumAdditions - sumDeductions
        this.setState({
                            ...
                            <Col name='printTargetCol' sm='11'>
                                ...
                                <Row className='printPageHeader'>
                                    <Col sm='12'>
                                        <Row name='row_01_HeaderAndBasicInfo' >
                                            ...
                                            <Col sm='4' name="header"> <h3> سفارش کالا و خدمات</h3></Col>
                                            ...
                                            <Col sm='4' name="basicInfo">
                                                ...
                                                <Row name="nativeDateOrder">

                                                    <Col sm="6" name="lable" style={{ paddingTop: '2%', textAlign: 'left' }}>
                                                        <Label for="nativeDateOrder">تاریخ:</Label>
                                                    </Col>
                                                    ...
                                                    <Col sm="6" name='input' style={{ textAlign: 'right', marginTop: '2%', fontWeight: '500', paddingLeft: '0' }}>
                                                        ...
                                                        <Input
                                                            type="text"
                                                            name="nativeDateOrder"
                                                            id="nativeDateOrder"
                                                            value={this.state.nativeDateOrder}
                                                        >
                                                        </Input>
                                                    </Col>
                                ...
                                <Row className='printPageTerm' name='termTable' hidden={this.state.isTermTableHidden}>
                                    <Col name="termTableHeader" sm='12' style={{ border: 'solid 1px', marginTop: '1%' }}>
                                        <Row >
                                            <Col sm='4'></Col>
                                            <Col sm='4' style={{ textAlign: 'center' }}> <h6> شرایط و ملاحظات سفارش </h6></Col>
                                            <Col sm='4'></Col>
                                    ...
                                    <Col name="termGrid" sm='12' style={{ width: '100%', padding: '0', border: 'solid 1px', overflowY: 'scroll' }}>
                                        <table style={{ width: '100%', tableLayout: 'auto', borderCollapse: 'collapse', textAlign: 'center' }} >
                                            <thead>
                                                ...
                                                {this.props.orderTermList.map((x, i = 0) =>
                                                    <tr>
...
const mapStateToProps = state => {
    return {
        ...
        orderTermList: state.order.orderTermList,
