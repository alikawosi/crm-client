...
import { saveOrderFinancialCase, postOrderFinancialCaseType, getOrderFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/order/order/order.action';
...
class FinancialCase extends PureComponent {
    ...
    gridLoadData = async () => {
        await this.setState({
            rowData: this.props.orderFinancialCaseList,
    ...
    save = async () => {
        if (this.validateFormOnButtonClick() === true) {
            ...
            await this.props.saveOrderFinancialCase(this.state.rowData)
            await this.calculateOrderTotalPrice()
    ...
    delete = async () => {
        ...
        await this.props.saveOrderFinancialCase(list)
        await this.calculateOrderTotalPrice()
        ...
        return (
            <Container fluid style={{ padding: '0 2%' }}>
                        ...
                        <Form style={{ padding: '1%' }}>
                            ...
                            <FormGroup name='financialCaseTypeRef' style={{ textAlign: 'right' }}>
                                ...
                                <Row>
                                    ...
                                    <Col name="financialCaseTypeRef" sm='6' >
                                        <Input
                                            type="select"
                ...
                <Row name='row_02_ButtonsAndResult'>
                    ...
                    <Col sm="3" name='col-01-Buttons' style={{ textAlign: 'right', marginTop: '5%' }}>
                    ...
                    <Col sm="9" name='col-03-SumAdditions' style={{ textAlign: 'right', marginTop: '2%', fontWeight: '500' }}>
