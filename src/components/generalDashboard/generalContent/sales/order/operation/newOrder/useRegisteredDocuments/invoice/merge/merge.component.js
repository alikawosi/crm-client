...
import { getOrdinalCodeDuplication, getMaxOrdinalCode, postInvoiceToOrderMerge, saveOrderProductMerge } from '../../../../../../../../../../redux/sales/order/order/order.action'
...
class Merge extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: ' تاریخ پیش فاکتور', field: "nativeDateInvoice" },
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postInvoiceToOrderMerge();
    ...
    postInvoiceToOrderMerge = async () => {
        ...
        await this.props.postInvoiceToOrderMerge(JSON.stringify(data))
    }
    /* #endregion */
    ...
    render() {
        ...
        return (
            <Container fluid style={{ margin: '0', padding: '0' }}>
                ...
                <Row name='row_03_InvoiceMergeGrid'>
                    <Col className="ag-theme-alpine" style={{ width: '100%', padding: '2%', height: '600px' }}>
                        ...
                        <AgGridReact
                            ...
                            rowData={this.props.invoiceMergedList}
...
const mapStateToProps = state => {
    return {
        ...
        invoiceMergedList: state.order.invoiceMergedList,
    }
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postInvoiceToOrderMerge: (data) => dispatch(postInvoiceToOrderMerge(data)),
