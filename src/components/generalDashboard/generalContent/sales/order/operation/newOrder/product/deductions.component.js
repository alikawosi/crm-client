...
import { saveOrderProductDeductions , postOrderFinancialCaseType, getOrderFinancialCaseTypeTitle} from '../../../../../../../../redux/sales/order/order/order.action'
...
class Deductions extends PureComponent {
    ...
    gridLoadData = () => {
        ...
        let list = this.props.orderProductDeductionList.filter(x => x.productRef === this.props.productRef)
    ...
    submit = () => {
        ...
        let tempList = this.props.orderProductDeductionList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
        ...
        return (
            <Container fluid style={{ padding: '0 2%' }}>
                ...
                <Row name='row_03_ButtonsAndResult'>
                    ...
                    <Col name='col-01-Buttons' sm='6' style={{ textAlign: 'right', marginTop: '2%' }}>
                    ...
                    <Col sm="3" name='col-03-SumDeductions' style={{ textAlign: 'right', marginTop: '2%', fontWeight: '500',paddingLeft:'1.5%' }}>
