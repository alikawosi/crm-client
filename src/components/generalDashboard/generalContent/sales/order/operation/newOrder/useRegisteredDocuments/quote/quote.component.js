...
class Quote extends PureComponent {
    ...
    split = async () => {
        ...
        await this.props.newQuoteToOrderSplit(this.state.headerRef, this.state.sellerTitle, this.state.buyerTitle, this.state.latinDateCreated);
    ...
    convert = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.newQuoteToOrderConvert(this.state.headerRef, this.state.latinDateCreated);
    }
    /* #endregion */
    ...
    merge = async () => {
        ...
        if (dateResult === true) {
            ...
            await this.props.newQuoteToOrderMerge(this.state.mergeHeaderRefList, latinDateCreated);
        }
    }
    /* #endregion */
