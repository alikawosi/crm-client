...
class Order extends PureComponent {
    ...
    split = async () => {
        ...
        await this.props.newOrderToOrderSplit(this.state.headerRef, this.state.sellerTitle, this.state.buyerTitle, this.state.latinDateCreated);
    }
    /* #endregion */
    ...
    corresponding = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.newOrderToOrderCorresponding(this.state.headerRef);
    }
    /* #endregion */
    ...
    merge = async () => {
        ...
        if (dateResult === true) {
            ...
            await this.props.newOrderToOrderMerge(this.state.mergeHeaderRefList, latinDateCreated);
        }
    }
    /* #endregion */
