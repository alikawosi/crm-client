...
import { getOrdinalCodeDuplication, getMaxOrdinalCode, postOrderToOrderMerge, saveOrderProductMerge } from '../../../../../../../../../../redux/sales/order/order/order.action'
...
class Merge extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: ' تاریخ پیش فاکتور', field: "nativeDateOrder" },
    ...
    validateFormOnButtonClick = () => {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            finalCountProductFlag = lenorderMergeProductList === lenOrderMergedProductRefList ? false : true

  
            if (finalCountProductFlag === false) {
                isFormValid = true
            }
            else if (finalCountProductFlag === true) {
                    this.setState({
                        isValidationModalVisible: true,
                        message: ' سفارش های انتخابی دارای کالای مشترک هستند.لطفا از بین کالاهای مشترک یکی را انتخاب کنید.'
                    })
    ...
    cancel = async () => {
        ...
        this.props.onCloseNewOrderMergeModal();
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postOrderToOrderMerge();
            await this.props.onCloseNewOrderMergeModal();
    ...
    postOrderToOrderMerge = async () => {
        ...
        await this.props.postOrderToOrderMerge(JSON.stringify(data))
    }
    /* #endregion */
    ...
    render() {
        ...
        return (
            <Container fluid style={{ margin: '0', padding: '0' }}>
                ...
                <Row name='row_03_OrderMergeGrid'>
...
const mapStateToProps = state => {
    return {
        ...
        orderMergedList: state.order.orderMergedList,
        orderMergedProductRefList: state.order.orderMergedProductRefList,
...
const mapDispatchToProps = dispatch => ({
    ...
    postOrderToOrderMerge: (data) => dispatch(postOrderToOrderMerge(data)),
