...
import { getInvoiceOrdinalCodeDuplication, getInvoiceMaxOrdinalCode, postOrderToInvoiceMerge } from '../../../../../../../../redux/sales/order/order/order.action'
...
class Merge extends PureComponent {
    ...
    validateForm = async (event) => {
     //   var errors = {};
        ...
        //             await this.getInvoiceOrdinalCodeDuplication(event.target.value * 1);
    ...
    refreshOrdinalCode = async () => {
        await this.getInvoiceMaxOrdinalCode();
        this.setState({
            ordinalCode: this.props.ordinalCode * 1 + 1,
          //  isOrdinalCodeInvalid:false,
           // isOrdinalCodeValid:true,
...
/* #endregion */
    ...
    getInvoiceOrdinalCodeDuplication = async (ordinalCode) => {
        let ordinalCodeDuplicationGetData = {
            domainRef: this.props.domain,
            ordinalCode: ordinalCode * 1
        }
        await this.props.getInvoiceOrdinalCodeDuplication(JSON.stringify(ordinalCodeDuplicationGetData));
    }
    /* #endregion */

    /* #region  [- getInvoiceMaxOrdinalCode -] */
    getInvoiceMaxOrdinalCode = async () => {
        let maxOrdinalCodeGetData = {
            domainRef: this.props.domain,
        }
        await this.props.getInvoiceMaxOrdinalCode(JSON.stringify(maxOrdinalCodeGetData));
    }
    /* #endregion */
...
const mapStateToProps = state => {
    return {
        ...
        orderMergedProductRefList: state.order.quoteMergedProductRefList,
    }
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    getInvoiceOrdinalCodeDuplication: (data) => dispatch(getInvoiceOrdinalCodeDuplication(data)),
    getInvoiceMaxOrdinalCode: (data) => dispatch(getInvoiceMaxOrdinalCode(data)),
});
/* #endregion */
