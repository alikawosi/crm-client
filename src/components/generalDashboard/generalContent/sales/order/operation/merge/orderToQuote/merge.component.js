...
import { getQuoteOrdinalCodeDuplication, getQuoteMaxOrdinalCode, postOrderToQuoteMerge } from '../../../../../../../../redux/sales/order/order/order.action'
...
class Merge extends PureComponent {
    ...
    validateForm = async (event) => {
        ...
        //             await this.getQuoteOrdinalCodeDuplication(event.target.value * 1);
    ...
    refreshOrdinalCode = async () => {
        await this.getQuoteMaxOrdinalCode();
        this.setState({
            ordinalCode: this.props.ordinalCode * 1 + 1,
            // isOrdinalCodeInvalid:false,
            // isOrdinalCodeValid:true,
    ...
    getQuoteOrdinalCodeDuplication = async (ordinalCode) => {
        let ordinalCodeDuplicationGetData = {
            domainRef: this.props.domain,
            ordinalCode: ordinalCode * 1
        }
        await this.props.getQuoteOrdinalCodeDuplication(JSON.stringify(ordinalCodeDuplicationGetData));
    }
    /* #endregion */

    /* #region  [- getQuoteMaxOrdinalCode -] */
    getQuoteMaxOrdinalCode = async () => {
        let maxOrdinalCodeGetData = {
            domainRef: this.props.domain,
        }
        await this.props.getQuoteMaxOrdinalCode(JSON.stringify(maxOrdinalCodeGetData));
    }
    /* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    getQuoteOrdinalCodeDuplication: (data) => dispatch(getQuoteOrdinalCodeDuplication(data)),
    getQuoteMaxOrdinalCode: (data) => dispatch(getQuoteMaxOrdinalCode(data)),
});
/* #endregion */
