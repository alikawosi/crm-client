...
import { getOrderExtraInformation, postOrderExtraInformation, deleteOrderExtraInformation, resetMessage } from '../../../../../../../redux/sales/order/order/order.action';
...
class ExtraInformation extends PureComponent {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.orderExtraInformationList !== prevProps.orderExtraInformationList) {
            this.setState({
                rowData: this.props.orderExtraInformationList
            })
        }
    ...
    save = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postOrderExtraInformation();
            this.resetForm();
        }
    }
    /* #endregion */
    ...
    delete = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteOrderExtraInformation();
        this.resetForm();
    }
    /* #endregion */
    ...
    getOrderExtraInformation = async () => {
        let orderExrtaInformationGetData = {
            orderHeaderRef: this.props.orderHeaderRef
        }
        await this.props.getOrderExtraInformation(orderExrtaInformationGetData);
    }
    /* #endregion */
    ...
    postOrderExtraInformation = async () => {
        let orderExtraInformationPostData = {
            orderHeaderRef: this.props.orderHeaderRef,
        ...
        await this.props.postOrderExtraInformation(orderExtraInformationPostData);
    }
    /* #endregion */

    /* #region  [- deleteOrderExtraInformation() -] */
    deleteOrderExtraInformation = async () => {
        let orderExtraInformationDeleteData = {
            orderHeaderRef: this.props.orderHeaderRef,
            orderExtraInformationIdList: [
                {
                    id: this.state.id
                }
            ]
        }
        await this.props.deleteOrderExtraInformation(orderExtraInformationDeleteData);
    }
    /* #endregion */
...
const mapStateToProps = state => {
    return {
        ...
        extraInfoFieldTypeList: state.order.extraInfoFieldTypeList,
        orderExtraInformationList: state.order.orderExtraInformationList,
...
const mapDispatchToProps = dispatch => ({
    getOrderExtraInformation: (data) => dispatch(getOrderExtraInformation(data)),
    postOrderExtraInformation: (data) => dispatch(postOrderExtraInformation(data)),
    deleteOrderExtraInformation: (data) => dispatch(deleteOrderExtraInformation(data)),
