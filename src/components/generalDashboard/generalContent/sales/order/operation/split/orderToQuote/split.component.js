...
import { postOrderToQuoteSplit, saveOrderToQuoteSplitedData } from '../../../../../../../../redux/sales/order/order/order.action'
    ...
    save = async () => {
        ...
        for (let i = 0; i < Object.keys(selectedData).length; i++) {
            let data = {
                ...
                quoteAdditions: selectedData[i].orderAdditions,
                quoteDeductions: selectedData[i].orderDeductions,
        ...
        await this.props.saveOrderToQuoteSplitedData(data)
...
const mapStateToProps = state => {
    return {
        ...
        quoteSplitList: state.order.quoteSplitList,
        quoteSplitProductList: state.order.quoteSplitProductList
    }
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    saveOrderToQuoteSplitedData: (data) => dispatch(saveOrderToQuoteSplitedData(data)),
});
/* #endregion */
