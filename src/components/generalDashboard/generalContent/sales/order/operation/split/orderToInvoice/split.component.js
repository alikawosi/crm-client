...
import { postOrderToInvoiceSplit, saveOrderToInvoiceSplitedData } from '../../../../../../../../redux/sales/order/order/order.action'
...
class Split extends PureComponent {
            ...
            detailCellRendererParams: {
                ...
                detailGridOptions: {
                    columnDefs: [
                        ...
                        { headerName: 'اضافات', field: "invoiceAdditions" ,valueFormatter: this.currencyFormatter,pinnedRowCellRenderer: 'customPinnedRowRenderer',},
                        { headerName: 'کسورات', field: "invoiceDeductions" ,valueFormatter: this.currencyFormatter,pinnedRowCellRenderer: 'customPinnedRowRenderer',},
    ...
    getDetailData = (params) => {
        let list = this.props.invoiceSplitProductList.filter(x => x.masterCode === params.data.code)
    ...
    submit = async () => {
        ...
        if (Object.keys(this.props.invoiceSplitList).length > 0 && Object.keys(this.state.productList).length === 0) {
            ...
            await this.props.onCloseSplitModal();
...
const mapStateToProps = state => {
    return {
        ...
        invoiceSplitList: state.order.invoiceSplitList,
        invoiceSplitProductList: state.order.invoiceSplitProductList
    }
};
/* #endregion */
