...
import { editOrderProductAdditions, postOrderFinancialCaseType, getOrderFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/order/order/order.action'
...
class Additions extends PureComponent {
    ...
    /* #region  [- gridLoadData -] */
    gridLoadData = () => {
        let list = this.props.orderItemProductAdditionsList.filter(x => x.productRef === this.props.productRef)
        ...
        if (this.props.sumAllAdditions.length !== 0) {
            ...
            let sumAdditionsList = []

            sumAdditionsList.push(
                {
                    productRef: this.props.productRef,
                    sumAdditions: finalSumAddition
                }
            )
    ...
    submit = () => {
        ...
        let tempList = this.props.orderItemProductAdditionsList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
...
<CurrencyInput
                ...
                <Row name='row_02_ButtonsAndResult'>
                    ...
                    <Col sm='3' md='3' lg='3' name='col-03-SumAdditions' style={{ textAlign: 'right', marginTop: '2%', fontWeight: '500', paddingLeft: '1.5%' }}>
