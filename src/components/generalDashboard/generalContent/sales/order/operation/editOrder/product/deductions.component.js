...
import { editOrderProductDeductions, postOrderFinancialCaseType, getOrderFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/order/order/order.action'
...
class Deductions extends PureComponent {
    ...
    submit = () => {
        ...
        let tempList = this.props.orderItemProductDeductionsList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
