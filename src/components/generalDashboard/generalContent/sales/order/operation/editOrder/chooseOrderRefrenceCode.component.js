...
class ChooseOrderRefrenceCode extends PureComponent {
    ...
    onSelectionChanged = () => {
        ...
        if (len === 0) {
            this.props.setOrderRefrenceCodeChooseButtonDisabled(true);
        }
        if (len === 1) {
            this.setState({
            ...
            this.props.setOrderRefrenceCodeChooseButtonDisabled(false);
        }
    }
    /* #endregion */
...
export default connect(mapStateToProps)(ChooseOrderRefrenceCode);