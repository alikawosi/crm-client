...
import {
    editOrderFinancialCaseType, postOrderFinancialCaseType, getOrderFinancialCaseTypeTitle, editOrderProductAdditions,
    editOrderProductDeductions,saveProductTotalPrice
...
class FinancialCase extends PureComponent {
    ...
    gridLoadData = async () => {
        await this.setState({
            rowData: this.props.orderItemFinancialCaseList,
    ...
    calculatePrice = async () => {
        ...
        let totalPrice = 0
        await this.props.orderItemProductList.map(x => {
    ...
    save = async () => {
        if (this.validateFormOnButtonClick() === true) {
            ...
            await this.props.editOrderFinancialCaseType(this.state.rowData)
            await this.calculateOrderTotalPrice()
    ...
    delete = async () => {
        ...
        await this.props.editOrderFinancialCaseType(list)
        await this.calculateOrderTotalPrice()
                                ...
                                <Col sm='6' md='6' lg='3'>
                                    ...
                                    <FormGroup name="additionOrDeduction" style={{ paddingRight: '5%' }}>
                                        ...
                                        <Label name="addition" check style={{ paddingLeft: '21%' }}>
                                            ...
                                            <Input type="radio" id="addition" value="addition" name="additionOrDeduction" checked={this.state.isAdditionChecked} onChange={this.handelChangeAddition} />{' '} اضافات

                                        </Label>

                                        <Label name="deduction" check>

                                            <Input type="radio" id="deduction" value="deduction" name="additionOrDeduction" checked={this.state.isDeductionChecked} onChange={this.handelChangeDeduction} />{' '} کسورات
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center' }} >
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td style={{ direction: 'ltr' }}>{this.state.orderTotalPrice.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}</td>
                                </tr>
