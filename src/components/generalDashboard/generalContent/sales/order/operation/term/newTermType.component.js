...
import { postTermType, getTermTypeTitle } from '../../../../../../../redux/sales/term/term.action';
import { checkTokenExpiration } from '../../../../../../../redux/shared/auth/auth.action';
/* #endregion */

class NewReportType extends PureComponent {
            ...
            termTypeList: [
                {
                    ...
                    shippingFlag: this.props.isShippingSwitchChecked,
    ...
    getTermTypeTitle = async () => {
        let termTypeTitleGetData = {
            domainRef: this.props.domain,
        }
        await this.props.getTermTypeTitle(JSON.stringify(termTypeTitleGetData));
    }
    /* #endregion */
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postTermType();
            if (this.props.isShippingSwitchChecked === false) {
                await this.getTermTypeTitle();
            }
            ...
            <Container fluid className="reacstrap-container" style={{ padding: "0" }} >
                ...
                <Row name='row_01_Header' className='form-header-row' style={{ margin: "0" }}>
                    <Col className="form-header-col">
                        <p className="form-header-title">نوع شرایط و ملاحضات جدید</p>
                    </Col>
                </Row>
...
const mapDispatchToProps = dispatch => ({
    ...
    getTermTypeTitle: (data) => dispatch(getTermTypeTitle(data)),
});

/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(NewReportType);
