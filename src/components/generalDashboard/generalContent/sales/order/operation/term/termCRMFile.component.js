...
class TermCRMFile extends PureComponent {
  //#region [- ctor -]
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    let list = [...this.props.termCRMFileList]
    this.setState({
      rowData: list,
    })
  }
...
const mapStateToProps = state => {
    return {
        ...
        termCRMFileList:state.term.termCRMFileList
    }
};
/* #endregion */


export default connect(mapStateToProps)(TermCRMFile);
