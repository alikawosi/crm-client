...
class Term extends PureComponent {
    ...
    submitAttachedFile = (data) => {
        this.setState({
            orderTermAttachedFileList: data,
    ...
    postTerm = async () => {
        ...
        let data =
        {
            ...
            type: 2,
            termList: list,
            termCRMFileList: this.state.orderTermAttachedFileList,
        }
        ...
        return (
            <Container fluid style={{ padding: '0 2% 4% 0' }}>
                        ...
                        <Form style={{ padding: '1%' }}>
                            ...
                            <FormGroup name='title' style={{ textAlign: 'right' }}  >
                                ...
                                <Col sm='12' md='12' lg='6'>
                                        <Input
                                            ...
                                            invalid={this.state.isTitletInvalid}
                            ...
                            <FormGroup name="attachFileButton">
                                <Col sm='12' md='12' lg='12' style={{ paddingRight: '0' }}>
                                    <Button className="submit-button-style m-1" onClick={this.onClickAttachFile}>
                                        پیوست
                                     </Button>
                                </Col>
                ...
                <Row name='row_02_Buttons'>
                    ...
                    <Col sm='12' md='12' lg="3"name='col-01-Buttons' style={{ textAlign: 'right'}}>
                        ...
                        <Container fluid>
                            ...
                            <Row name='content' style={{ marginBottom: '3%' }}>
                                <AttachFile
                                    ...
                                    orderTermAttachedFileList={this.state.orderTermAttachedFileList}
