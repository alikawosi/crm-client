...
import { editQuoteProductAdditions, postQuoteFinancialCaseType, getQuoteFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/quote/quote/quote.action'
...
class Additions extends PureComponent {
    ...
    submit = () => {
        ...
        let tempList = this.props.quoteItemProductAdditionsList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
