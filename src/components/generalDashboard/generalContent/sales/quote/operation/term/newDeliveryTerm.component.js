...
import { postDeliveryTerm, getDeliveryTermTitle } from '../../../../../../../redux/sales/term/term.action';
...
class NewDeliveryTerm extends PureComponent {
    ...
    getDeliveryTermTitle = async () => {
        let deliveryTermPostData = {
            domainRef: this.props.domain,
        }
        await this.props.getDeliveryTermTitle(JSON.stringify(deliveryTermPostData));
    }
    /* #endregion */
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            ...
            await this.getDeliveryTermTitle();
...
const mapDispatchToProps = dispatch => ({
    ...
    getDeliveryTermTitle: (data) => dispatch(getDeliveryTermTitle(data)),
});
