...
import { getQuoteExtraInformation, postQuoteExtraInformation, deleteQuoteExtraInformation, resetProps } from '../../../../../../../redux/sales/quote/quote/quote.action';
...
class ExtraInformation extends PureComponent {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.quoteExtraInformationList !== prevProps.quoteExtraInformationList) {
            this.setState({
                rowData: this.props.quoteExtraInformationList
            })
        }
...
//#endregion
    ...
    save = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postQuoteExtraInformation();
            this.resetForm();
        }
    }
    /* #endregion */
    ...
    delete = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.deleteQuoteExtraInformation();
        this.resetForm();
    }
    /* #endregion */
    ...
    getQuoteExtraInformation = async () => {
        let quoteExrtaInformationGetData = {
            quoteHeaderRef: this.props.quoteHeaderRef
        }
        await this.props.getQuoteExtraInformation(quoteExrtaInformationGetData);
    }
    /* #endregion */
    ...
    postQuoteExtraInformation = async () => {
        let quoteExtraInformationPostData = {
            quoteHeaderRef: this.props.quoteHeaderRef,
        ...
        await this.props.postQuoteExtraInformation(quoteExtraInformationPostData);
    }
    /* #endregion */

    /* #region  [- deleteQuoteExtraInformation() -] */
    deleteQuoteExtraInformation = async () => {
        let quoteExtraInformationDeleteData = {
            quoteHeaderRef: this.props.quoteHeaderRef,
            quoteExtraInformationIdList: [
                {
                    id: this.state.id
                }
            ]
        }
        await this.props.deleteQuoteExtraInformation(quoteExtraInformationDeleteData);
    }
    /* #endregion */
...
const mapStateToProps = state => {
    return {
        ...
        extraInfoFieldTypeList: state.quote.extraInfoFieldTypeList,
        quoteExtraInformationList: state.quote.quoteExtraInformationList,
...
const mapDispatchToProps = dispatch => ({
    getQuoteExtraInformation: (data) => dispatch(getQuoteExtraInformation(data)),
    postQuoteExtraInformation: (data) => dispatch(postQuoteExtraInformation(data)),
    deleteQuoteExtraInformation: (data) => dispatch(deleteQuoteExtraInformation(data)),
