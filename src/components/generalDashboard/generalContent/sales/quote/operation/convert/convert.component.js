...
import { postQuoteToOrderConvert, getOrderInventory } from '../../../../../../../redux/sales/quote/quote/quote.action'
...
class Convert extends PureComponent {
    ...
    validateFormOnButtonClick = () => {
        ...
        for (let i = 0; i < Object.keys(quoteProductList).length; i++) {
            let filteredList = this.props.orderProductQuantityList.filter(x => x.productRef === quoteProductList[i].id)
    ...
    submit = async () => {
        ...
        if (this.validateFormOnButtonClick() === true) {
            await this.postQuoteToOrderConvert();
    ...
    onCancelProductQuantity = async () => {
        ...
        await this.gridApi.setRowData(this.props.quoteProductList)
    }
    /* #endregion */
    ...
    postQuoteToOrderConvert = async () => {
        ...
        await this.props.postQuoteToOrderConvert(JSON.stringify(data))
    }
    /* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postQuoteToOrderConvert: (data) => dispatch(postQuoteToOrderConvert(data)),
