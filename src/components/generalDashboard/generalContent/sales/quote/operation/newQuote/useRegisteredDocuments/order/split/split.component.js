...
import { postOrderToQuoteSplit, saveQuoteSplit } from '../../../../../../../../../../redux/sales/quote/quote/quote.action'
...
class NewQuoteSplit extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            productColumnDefs: [
                ...
                { headerName: 'مبلغ پیش فرض', field: "unitPrice", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
                { headerName: 'تعداد', field: "quantity", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
                { headerName: 'مبلغ', field: "price", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
                { headerName: 'اضافات', field: "orderAdditions", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
                { headerName: 'کسورات', field: "orderDeductions", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
                { headerName: 'مبلغ نهایی', field: "finalPrice", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
    ...
    submit = async () => {
        ...
        if (Object.keys(this.props.quoteSplitList).length > 0 && Object.keys(this.state.productList).length === 0) {
            await this.postOrderToQuoteSplit();
    ...
    postOrderToQuoteSplit = async () => {
        ...
        await this.props.postOrderToQuoteSplit(JSON.stringify(data))
    }
    /* #endregion */
                ...
                <Row name='row_06_QuoteSplitGrid'>
                    <Col className="ag-theme-alpine" style={{ width: '100%', padding: '2%', height: '400px' }}>
                        ...
                        <AgGridReact
                            ...
                            localeText={AG_GRID_LOCALE_FA}
                        // gridOptions={this.state.quoteGridOptions}
                        />
...
const mapStateToProps = state => {
    return {
        ...
        orderProductList: state.quote.orderProductList,
...
const mapDispatchToProps = dispatch => ({
    ...
    postOrderToQuoteSplit: (data) => dispatch(postOrderToQuoteSplit(data)),
