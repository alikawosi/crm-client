...
import { saveQuoteFinancialCaseType, postQuoteFinancialCaseType, getQuoteFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/quote/quote/quote.action';
...
class FinancialCase extends PureComponent {
    ...
    gridLoadData = async () => {
        await this.setState({
            rowData: this.props.quoteFinancialCaseList,
    ...
    save = async () => {
        if (this.validateFormOnButtonClick() === true) {
            ...
            await this.props.saveQuoteFinancialCaseType(this.state.rowData)
            await this.calculateQuoteTotalPrice()
        }
    ...
    delete = async () => {
        ...
        await this.props.saveQuoteFinancialCaseType(list)
        await this.calculateQuoteTotalPrice()
