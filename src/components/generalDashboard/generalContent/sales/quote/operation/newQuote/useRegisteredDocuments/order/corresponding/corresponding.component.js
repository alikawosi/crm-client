...
import { postOrderToQuoteCorresponding } from '../../../../../../../../../../redux/sales/quote/quote/quote.action'
...
class NewQuoteCorresponding extends PureComponent {
    ...
    submit = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.postOrderToQuoteCorresponding();
    ...
    postOrderToQuoteCorresponding = async () => {
        let quoteHeaderList = []
        ...
        await this.props.postOrderToQuoteCorresponding(JSON.stringify(data))
    }
    /* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postOrderToQuoteCorresponding: (data) => dispatch(postOrderToQuoteCorresponding(data)),
});
/* #endregion */
