...
import { saveQuoteProductDeductions, postQuoteFinancialCaseType, getQuoteFinancialCaseTypeTitle } from '../../../../../../../../redux/sales/quote/quote/quote.action'
...
class Deductions extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columnDefs: [
                ...
                { headerName: '(درصد)مقدار', field: "financialCasePercent", pinnedRowCellRenderer: 'customPinnedRowRenderer', },
    ...
    gridLoadData = () => {
        ...
        let list = this.props.quoteProductDeductionList.filter(x => x.productRef === this.props.productRef)
    ...
    submit = () => {
        ...
        let tempList = this.props.quoteProductDeductionList.filter(x => x.productRef !== this.props.productRef)
        this.state.rowData.map(x => {
            tempList.push(x)
        })
        ...
        return (
            <Container fluid style={{ padding: '0 2%' }}>
                ...
                <Row name='row_02_ButtonsAndResult'>
                    ...
                    <Col sm='6' md='6' lg='6' name='col-01-Buttons' style={{ textAlign: 'right', marginTop: '2%' }}>
