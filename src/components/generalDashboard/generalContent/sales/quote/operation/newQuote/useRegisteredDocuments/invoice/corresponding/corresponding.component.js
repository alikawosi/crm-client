...
import { postInvoiceToQuoteCorresponding } from '../../../../../../../../../../redux/sales/quote/quote/quote.action'
...
class NewQuoteCorresponding extends PureComponent {
    ...
    submit = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.postInvoiceToQuoteCorresponding();
    ...
    postInvoiceToQuoteCorresponding = async () => {
        let quoteHeaderList = []
        ...
        await this.props.postInvoiceToQuoteCorresponding(JSON.stringify(data))
    }
    /* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postInvoiceToQuoteCorresponding: (data) => dispatch(postInvoiceToQuoteCorresponding(data)),
});
/* #endregion */
