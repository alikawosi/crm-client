...
import { getOrderToQuoteSplitData, getOrderToQuoteMergeData } from '../../../../../../../../../redux/sales/quote/quote/quote.action'
...
class Order extends PureComponent {
    ...
    split = async () => {
        ...
        await this.props.newOrderToQuoteSplit(this.state.headerRef, this.state.sellerTitle, this.state.buyerTitle, this.state.latinDateCreated);
    }
    /* #endregion */
    ...
    corresponding = async () => {
        await this.props.checkTokenExpiration(this.props.checkTokenCounter);
        await this.props.newOrderToQuoteCorresponding(this.state.headerRef);
    }
    /* #endregion */
    ...
    merge = async () => {
        ...
        if (dateResult === true) {
            ...
            await this.getOrderToQuoteMergeData();
            await this.props.newOrderToQuoteMerge(this.state.mergeHeaderRefList, latinDateCreated);
        }
    ...
    getOrderToQuoteSplitData = async () => {
        let data = {
            ...
            orderHeaderRef: this.state.headerRef,
        }
    ...
    getOrderToQuoteMergeData = async () => {
        let data = {
            domainRef: this.props.domain,
...
const mapStateToProps = state => {
    return {
        ...
        orderListByAccount: state.quote.orderListByAccount,
    }
};
/* #endregion */
