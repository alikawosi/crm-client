...
import { saveProductTotalQuantity } from '../../../../../../../redux/sales/quote/quote/quote.action'
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            selectedInventoryColumnDefs: [
                ...
                { headerName: 'تعداد', field: "requestesNumber", pinnedRowCellRenderer: 'customPinnedRowRenderer', valueFormatter: this.currencyFormatter, },
        ...
        return (
            <Container fluid style={{ padding: '0 2%' }}>
                ...
                <Row name='row_03_ButtonsAndResult'>
                    ...
                    <Col sm='12' md='12' lg='6' name='col-02' ></Col>
