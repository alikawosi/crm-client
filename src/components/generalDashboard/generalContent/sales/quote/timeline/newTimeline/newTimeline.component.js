...
import { postTimeline, postQuoteTimelineManualActivityType } from '../../../../../../../redux/sales/quote/timeline/timeline.action'
...
class NewTimeline extends PureComponent {
    ...
    postTimelineManualActivityType = async (data) => {
        await this.props.postQuoteTimelineManualActivityType(JSON.stringify(data));
...
const mapStateToProps = state => {
    return {
        ...
        manualActivityTypeTitleList: state.quoteTimeline.manualActivityTypeTitleList,
    };
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    postQuoteTimelineManualActivityType: (data) => dispatch(postQuoteTimelineManualActivityType(data)),
});
