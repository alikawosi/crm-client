...
import { cancelNewPriceList, getOrdinalCodeDuplication, getMaxOrdinalCode, savePriceListBasicInformation, postPriceList, resetProps } from '../../../../../../../redux/sales/priceList/priceList/priceList.action'
...
class NewPriceList extends PureComponent {
    ...
    setNextStepDisabled = async () => {
        if (this.props.tempPriceListProductList.length !== 0) {
            await this.setState({
                isNextStepDisabled: false,
    ...
    nextStep = async () => {
        ...
        await this.props.savePriceListBasicInformation(data);
    }
    /* #endregion */

    /* #region  [- save -] */
    save = async () => {
        await this.postPriceList();
    ...
    postPriceList = async () => {
        ...
        await this.props.postPriceList(JSON.stringify(data));
    }
    /* #endregion */
            ...
            <Container fluid style={{ backgroundColor: 'white' }}>
                ...
                <Row name='row_01_Header' className='mb-2' style={{ borderBottom: '1px solid #f0f0f0', height: '5vh' }}>
                    <Col style={{ direction: 'rtl', textAlign: 'right' }}>
                        <span style={{ height: '48px', lineHeight: '35px', fontSize: '17px', fontWeight: 'bold' }}>لیست قیمت جدید</span>
                    </Col>
                </Row>
...
const mapStateToProps = state => {
    return {
        ...
        ordinalCodeDuplication: state.priceList.ordinalCodeDuplication,
    }
};
/* #endregion */
...
const mapDispatchToProps = dispatch => ({
    ...
    savePriceListBasicInformation: (data) => dispatch(savePriceListBasicInformation(data)),
    resetProps: () => dispatch(resetProps()),
    postPriceList: (data) => dispatch(postPriceList(data))
});
/* #endregion */

export default connect(mapStateToProps, mapDispatchToProps)(NewPriceList);