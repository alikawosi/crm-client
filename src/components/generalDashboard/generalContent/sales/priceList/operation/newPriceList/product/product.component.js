...
import { getPriceListProduct, getProduct, savePriceListProductData } from '../../../../../../../../redux/sales/priceList/priceList/priceList.action';
...
class Product extends PureComponent {
    ...
    gridLoadData = () => {
        ...
        this.setState({
            selectedProductList: this.props.tempPriceListProductList
        })
    ...
    save = async () => {
        ...
        if (this.state.selectedProductList.length === 0) {
            ...
            await this.props.savePriceListProductData(selectedData)
            ...
            await this.props.savePriceListProductData(this.state.selectedProductList)
    ...
    delete = () => {
        ...
        this.props.savePriceListProductData(list)
...
const mapDispatchToProps = dispatch => ({
    ...
    savePriceListProductData: (data) => dispatch(savePriceListProductData(data))
});
/* #endregion */
