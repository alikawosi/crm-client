...
import { getPersonFormData ,getPersonNationalCodeDuplication} from '../../../../../../../../redux/infrastructure/person/person.action';
import { postPersonAccount } from '../../../../../../../../redux/crm/account/account/person/personAccount.action'
import { putPerson } from '../../../../../../../../redux/infrastructure/person/person.action';
import NewEducationLevel from '../../../../../generalSetting/person/educationLevel/newEducationLevel.component';
...
class PersonalInformation extends PureComponent {
    ...
    postPersonAccount = async () => {
        if (await this.validateFormOnButtonClick() === true) {
            ...
            await this.props.postPersonAccount(personPostData);
            return true
        }
        else {
            return false
                ...
                <Row name='form'>
                    <Col sm='12'>
                        <Form>
                            ...
                            <Row name="codeAndFirstNameAndImage">
                                <Col sm='6'>
                                ...
                                <Col sm='4'></Col>
                                <Col title='personalImage' sm='2' style={{ paddingTop: '2%', textAlign: 'center' }}>
                                    <Row>
                                        <Upload
                                            name="personalImage"
                            ...
                            <Row name='otherField'>
                                <Col sm='6'>
                                    <FormGroup name='surname' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='fatherName' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='idNumber' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='nationalCode' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='placeOfBirth' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='educationLevelRef' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='industryList' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='mobile' style={{ textAlign: 'right' }}>
                                    ...
                                    <FormGroup name='personAddress' style={{ textAlign: 'right' }}>
...
const mapDispatchToProps = dispatch => ({
    postPersonAccount: (data) => dispatch(postPersonAccount(data)),
