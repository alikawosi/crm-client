...
import { getOrganizationFormData, putOrganization, getOrganizationNationalIdDuplication } from '../../../../../../../../redux/infrastructure/organization/organization.action'
import NewWorkField from '../../../../../generalSetting/person/workField/newWorkField.component'
import NewOrganizationType from '../../../../../generalSetting/person/organizationType/newOrganizationType.component'
import { Multiselect } from 'react-widgets'
import { checkTokenExpiration } from '../../../../../../../../redux/shared/auth/auth.action';
import { postOrganizationAccount } from '../../../../../../../../redux/crm/account/account/organization/organizationAccount.action'
...
class RegistrationInformation extends PureComponent {
  ...
  postOrganizationAccount = async () => {
    if (await this.validateFormOnButtonClick() === true) {
      ...
      let organizationPostData = {
        ...
        organizationList: [
          {
            parentId: this.state.parentId === '' ? null : parseInt(this.state.parentId),
      ...
      await this.props.postOrganizationAccount(organizationPostData);
      return true;
    }
    else {
      return false;
  ...
  /* #region  [- postOrganizationAccountType -] */
  postOrganizationAccountType = async () => {
    await this.props.checkTokenExpiration(this.props.checkTokenCounter);
    await this.child.postOrganizationAccountType();
    ...
    return (
      <Container>
        <Row name='form'>
          <Col sm='12'>
            <Form>
              <Row name="parentIdAndImageAndSwitches" style={{ paddingTop: "4%" }}>

                <Col sm="4" name="parentIdSelectAndSwitchs">
                  <FormGroup sm="4" name="parentId" style={{ textAlign: "right" }}>
                    <Row name='parentIdSwitch'>
                    ...
                    <Row name='parentIdSelect' hidden={this.state.isParentIdSelectHidden} style={{ marginLeft: "1%" }} >
                ...
                <Col sm='6'></Col>
                <Col sm="2" title="image" style={{ textAlign: 'center' }} >
                  <Row>
                    <Upload
                      name="logo"
              ...
              <Row name="industryAndOrganizationtypeSelect">
                <Col>

                  <FormGroup name="industry" style={{ textAlign: "right" }}>
              ...
              <Row name="organizationinformation">
                <Col sm="6">
                  ...
                  <hr />
                  <FormGroup name="registrationTitle" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="registrationNumber" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="nationalId" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="economicCode" style={{ textAlign: "right" }} >
                  ...
                  <FormGroup name="organizationSubject" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="workField" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="organizationScale" style={{ textAlign: "right" }} >
                  ...
                  <FormGroup name="branchType" style={{ textAlign: "right" }} >
                  ...
                  <hr />
                  <FormGroup name="introducer" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="tel" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="fax" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="website" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="postalCode" style={{ textAlign: "right" }}>
                  ...
                  <FormGroup name="organizationAddress" style={{ textAlign: "right" }}>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  postOrganizationAccount: (data) => dispatch(postOrganizationAccount(data)),
