...
export const propertyReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionType.GET_PROPERTYFORMDATA:
            return {
                ...state,
                propertyScaleFullPathList: action.result.propertyScaleFullPathList,
                propertyFieldTypeTitleList: action.result.propertyFieldTypeTitleList,
            };
        ...
        case actionType.GET_PROPERTYCRMFILE:
            return {
                ...state,
                propertyCRMFileList: action.result.propertyCRMFileList,
            };
