...
export const getWarehouse = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P54', data, { headers: header });
...
export const getWarehouseFullPath = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P55', data, { headers: header });
...
export const getWarehouseCategoryTitle = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P57', data, { headers: header });
...
export const getWarehouseItem = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P56', data, { headers: header });
...
export const postWarehouse = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P58', data, { headers: header });
...
export const deleteWarehouse = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P59', data, { headers: header });
...
export const putWarehouse = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(productUrl + 'P60', data, { headers: header });
