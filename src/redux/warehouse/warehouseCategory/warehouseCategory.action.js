...
export const getWarehouseCategory = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'getWarehouseCategory', data, { headers: header });
...
export const getWarehouseCategoryFormData = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'getWarehouseCategoryFormData', data, { headers: header });
...
export const getWarehouseCategoryItem = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'getWarehouseCategoryItem', data, { headers: header });
...
export const postWarehouseCategory = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'postWarehouseCategory', data, { headers: header });
...
export const deleteWarehouseCategory = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'deleteWarehouseCategory', data, { headers: header });
...
export const putWarehouseCategory = (data) => {
    return async (dispatch) => {
        try {
            ...
            var response = await axios.post(warehouseUrl + 'putWarehouseCategory', data, { headers: header });
